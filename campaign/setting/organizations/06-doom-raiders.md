...
- **Davil Starsong** — Cell leader of the Doom Raiders, primary faction contact. See the **Davil Starsong** page in Notable Figures.
- **Yagra Stonefist** — Street contact and Davil's bodyguard; present at the Yawning Portal. See the **Yagra Stonefist** page in Notable Figures.
- **Istrid Horn** — Master of Trade and Coin; runs the faction's lending operation from a Dock Ward warehouse. See the **Istrid Horn** page in Notable Figures.
- **Skeemo Weirdbottle** — Master of Magic; runs Weirdbottle's Concoctions in the Trades Ward. Traitor feeding intelligence to Manshoon's cell. See the **Skeemo Weirdbottle** page in Notable Figures.
- **Tashlyn Yafeera** — Master of Arms and Mercenaries; secondary contact after Davil's arrest. See the **Tashlyn Yafeera** page in Notable Figures.
- **Ziraj the Hunter** — Master of Assassination; operates from the rooftops and Corellon's Crown. See the **Ziraj the Hunter** page in Notable Figures.
- **Senna Vael** — Doom Raiders plant placed as a server candidate at Trollskull Manor. See the **Senna Vael** page in Notable Figures.
