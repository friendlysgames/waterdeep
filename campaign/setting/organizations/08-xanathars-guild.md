...
- **Noska Ur'gray** (DH p. 213) — Shield dwarf enforcer, neutral evil. Xanathar's heaviest response option. Leads the third-tier response team when earlier escalations fail. See the **Noska Ur'gray** page in Notable Figures.
...
- **Korgstrod Uxgulm** — Duergar (Tier 2 response team leader), lawful evil. Duergar leader of the sewer hideout beneath Orb Confectioners. Leads the second-tier response team. See the **Korgstrod Uxgulm** page in Notable Figures.
- **Gorath** — Duergar (Tier 1 response team leader), lawful evil. See the **Gorath** page in Notable Figures.
