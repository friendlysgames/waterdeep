...
His agenda in the Grand Game is territorial. Xanathar held the Stone of Golorr until Dalakhar stole it; he still holds one of its Eyes. The gold itself holds little appeal; the leverage it represents is everything. He wants the Stone recovered and the vault kept hidden — a source of leverage he can threaten but never has to use.

## Key Members

- **Xanathar** — Beholder crime lord, lawful evil. See the **Xanathar** page in Notable Figures.
- **Ahmaergo** (DH p. 195) — Shield dwarf majordomo, lawful evil. Ahmaergo handles logistics: gladiatorial procurement, outpost resupply, discipline. Most orders that bear Xanathar's name are written by Ahmaergo. See the **Ahmaergo** page in Notable Figures.
- **Nar'l Xibrindas** (DH p. 213) — Drow mage, neutral evil. Xanathar's advisor and secret Bregan D'Aerthe asset. Nar'l reports to Jarlaxle by *Sending* spell and has been operating in place for three years. The smokepowder delivery referenced in the Korgstrod correspondence was his operation. See the **Nar'l Xibrindas** page in Notable Figures.
- **Nihiloor** (DH p. 213) — Mind flayer, lawful evil. Officially handles Xanathar's most sensitive intelligence operations. In practice, Nihiloor is running three concurrent projects: (1) **The Infiltration** — intellect devourers placed inside city government officials give Nihiloor eyes throughout Waterdeep's bureaucracy; three Harper assets are already compromised; (2) **The Experiments** — creatures captured during Arena operations are being subjected to psionic modification seeking a "relay organism" that extends the colony's reach without destroying the host brain; (3) **The Puppet** — Nihiloor has been exerting psionic domination over Xanathar himself for the past four months, replacing his strategic decisions while leaving his personality intact. Evidence exists in Nihiloor's research chamber in the deep lair; its long-term payoff is the Seadeeps colony (Undermountain Level 17). See the **Nihiloor** page in Notable Figures.
- **Noska Ur'gray** (DH p. 213) — Shield dwarf enforcer, neutral evil. Xanathar's heaviest response option. Leads the third response team when earlier escalations fail. See the **Noska Ur'gray** page in Notable Figures.
- **Ott Steeltoes** — Dwarf cult fanatic (Zuggtmoy), neutral evil. Xanatharian field agent, currently held prisoner in the Zhentarim Interrogation House. Wears a leather skullcap stitched with fake beholder eyestalks. If rescued and cultivated, he can lead the PCs toward Xanathar's Lair. See the **Ott Steeltoes** page in Notable Figures.
- **Thorvin Twinbeard** — Dwarf engineer (secret Harper), neutral good. See the **Thorvin Twinbeard** page in Notable Figures.
- **Keln Trigos** — Tiefling priest (Xanathar Guild), neutral evil. Stationed at the Terasse Estate. Provides healing for Xanatharian agents and manages the gladiatorial audience transports to the Lair. See the **Keln Trigos** page in Notable Figures.
- **Grinda Garloth** — Human mage (black market armorer), neutral. Black market armorer based at Mistshore. Allied with Xanathar; equips Xanatharian agents and rents equipment to third parties, including (per the documents) Bregan D'Aerthe. See the **Grinda Garloth** page in Notable Figures.
- **Korgstrod Uxgulm** — Duergar (second response team leader), lawful evil. Duergar leader of the sewer hideout beneath Orb Confectioners. Leads the second response team. See the **Korgstrod Uxgulm** page in Notable Figures.
- **Gorath** — Duergar (first response team leader), lawful evil. See the **Gorath** page in Notable Figures.
- **Grevik Nass** — Half-orc cook, neutral evil. See the **Grevik Nass** page in Notable Figures.
- **Tobrin Ashvale** — Human bartender, neutral evil. See the **Tobrin Ashvale** page in Notable Figures.
...
*Area D3 — Arms and Armor.* A wide assortment of mundane arms and armor, including several single-shot pistols. At any given time: 3 pieces of magic arms/armor (DMG Table F) and 3 miscellaneous magic items (DMG Table A or B).
...
*Each entry names the document or discovery and, in parentheses, where it is found. These lists adhere to the Three Clue Rule: at minimum, three independent paths lead to each location. Create additional clues dynamically through tracking, interrogation, and PC research.*
