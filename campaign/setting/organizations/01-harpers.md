...
- **Mirt** — Illuskan human moneylender; Harper senior operative, Masked Lord, Laeral Silverhand's closest advisor. See the **Mirt** page in Notable Figures.
...
- **Corene Wyldath** — Halfling Harper deep-cover agent embedded in the Xanathar Guild's Dock Ward operation; compromised by an intellect devourer as of three weeks before Mission 5. See the **Corene Wyldath** page in Notable Figures.
