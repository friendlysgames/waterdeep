...
Debts of the City are the lingering obligations your character already carries when the campaign begins. Waterdeep runs on favors, markers, and binding agreements. Its power brokers, noble houses, criminal guilds, moneylenders, and worse, rarely deal in simple coin. They deal in leverage, and every character starts the story already owing someone.

Each of you chooses one Debt of the City. Unlike a backstory event, a Debt doesn't end. It follows your character. It's a social and narrative anchor that plants you inside the city's power structures and the Grand Game before the first session is over.

Roll or choose from the table below, then read your character's full entry.
...
> [!info]**Choosing a Debt**
> Each character takes exactly one Debt of the City. Roll a d8 or choose the entry that fits your concept, then read the full text below.
>
> A Debt doesn't wrap up at character creation and it doesn't end at session one. It follows your character for the whole campaign. Only what "your character knows" tells you is certain: how the Debt started and where things stand right now. Whether the holder is watching, waiting, or has already moved on is something you'll learn at the table, not something to assume in advance.
>
> Bring questions about your Debt to your GM, not to another player's entry. Your Debt is yours, and it may have nothing to do with anyone else's.

## Ambition: Istrid Horn's Ledger

You needed coin for something (a venture, a passage, a crisis), and Istrid Horn provided it. The terms were fair, the interest reasonable, and the dwarf behind the table was businesslike to the point of tedium. What made you uneasy afterward was how little she seemed to need reassurance that you would pay.

The loan has since been partially repaid. What remains isn't enough to panic over. What remains is enough to keep you in Istrid Horn's ledger, and her ledger is, as best you can determine, flawless. Every entry. Every outstanding balance. Every note about a debtor's known associates.
...
Noble house seals aren't difficult to obtain if you're patient and move in the right circles. The Gralhund family crest, sword above shield in green and silver, opened a door your actual credentials never would have. A letter of introduction signed with that seal got you into a building, a meeting, an arrangement. You didn't forge it yourself. You paid someone to. The distinction matters to you and to no one else.

What you didn't know when you acquired the credential was that Yalah Gralhund is meticulous about her family's name, employs people whose entire purpose is protecting it, and has recently become extremely attentive to unauthorized use of her correspondence.
...
The job was supposed to be clean. The Xanathar Guild was acquiring something from a rival organization, and you were hired to facilitate transit and paid well enough not to ask questions. What came out of there wasn't what you'd been told. What you left behind was considerably worse. The Guild got its item. The irregularities were absorbed into a larger accounting of that night, and your involvement went officially unnoted.

Ahmaergo, Xanathar's dwarven majordomo and the man who actually runs the Guild's logistics, keeps a private ledger separate from the official records. Your name is in it, under a column that reads *Outstanding*.
...
- [GM Guide: Debts of the City](../gm-guide/debts-of-the-city.md) — DM superset; includes Holder guidance and the Design Note
