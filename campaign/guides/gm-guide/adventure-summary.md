...
- `ch3-running-the-campaign.md` Section 2: "Adventure Summary"
- `29. Addendum Timelines & Starting the Campaign.pdf` — festival calendar, campaign start date, and pacing guidance

## Cross-References

- [Structural Rules](structural-rules.md) — recurring mechanics invoked throughout these acts
- [Grand Game in Play](grand-game-in-play.md) — faction positions at campaign start
- [Design Notes: Running the Campaign](design-notes-running-the-campaign.md) — why the act structure works this way
