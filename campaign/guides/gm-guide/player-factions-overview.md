...
| Rank | Renown | Benefits |
|------|--------|---------|
| **Initiate** | 1 | Recognized operative. Safe house access through the faction's harbor network. Access to specialized equipment from faction supply lines at cost. All faction members extend professional courtesy and will not act against you without orders from above. |
