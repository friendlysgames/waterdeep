...
- **Starting Renown.** Your Renown with a faction starts at 0 the moment you join.
- **Rank thresholds.** Named ranks unlock at Renown 1, 3, 10, 25, and 50. Benefits are cumulative. A character at Renown 10 keeps everything earned at 1 and 3.
- **Earning Renown.** You earn Renown by completing faction missions and by taking the specific Grand Game actions each faction lists under its own Earning Renown section. No other source awards Renown; general good roleplay earns none on its own.
- **Losing Renown.** Serious offenses cost 2 Renown each: betraying a mission, harming faction members, or working against the faction's interests. Renown never falls below 0.
- **Lords' Alliance discipline.** The Lords' Alliance is the only faction that enforces consequences for refusing or failing an assigned mission without compelling reason: formal suspension until reinstated, or outright dismissal.

> [!info]**Renown at a Glance**
> Starts at 0. Ranks unlock at 1, 3, 10, 25, and 50. Serious offenses cost 2 Renown each; Renown never drops below 0. Only the Lords' Alliance suspends or dismisses members over a refused or failed mission.
...
| **Harpshadow** | 3 | Your contact answers one direct question per tenday about faction activity or Waterdeep politics. Street-level contacts in the Dock Ward, Trades Ward, and Castle Ward share intelligence on any faction once per tenday: known agents, movement patterns, recent activity. |
...
| **Wise Owl** | 25 | The faction covers one sensitive operation per quest: forged documents, coordinated distractions, or witnesses who saw nothing. Informants inside rival factions can be activated for one specific intelligence request each per quest (DC 13 Charisma check; failure means the informant is unavailable for two tendays). You learn a second *persona*. When a villain faction designates you as a priority target, your handlers warn you within 24 hours. The faction can arrange a private audience with city leadership if it's urgent. |
| **High Harper** | 50 | Full access to Harper intelligence archives for the North. Request a team of three Harper agents for one operation. A senior Harper personally accompanies you on one mission of your choosing, drawing on a connection to Waterdeep's power structure that opens doors across the city. Request a covert extraction from anywhere in the city, or ask the High Harpers to formally expose a villain faction's activities to the Open Lord. You learn a third *persona*. |

> [!warning]**High Harper: What the Row Doesn't Say**
> The senior Harper is **Mirt**, and at this rank he reveals that he is a Masked Lord of Waterdeep. He can be asked to act in that capacity once. The player-facing row stays vague so the reveal lands at the table. See the Harpers Factions guide page and the **High Harper** rank event.

### Lords' Alliance

The Alliance rewards intelligence that reaches the right authorities and actions that protect the city's stability. Missions it assigns aren't optional; it's the only faction to say so plainly.
...
| **Redknife** | 3 | Your contact requests a Watch escort of two guards for one dangerous errand per tenday. Access to Alliance safe houses in the Castle and Trades Wards. Minor charges dropped or a Watch report suppressed once per tenday. |
| **Stingblade** | 10 | Your contact arranges an introduction to one named person in Waterdeep's political or merchant class once per quest. Alliance covers legal costs for one incident per quest: bail, fines, damages. Access to Watch crime reports, witness statements, and active investigation files for any case in the city (classified cases require 4 hours and a DC 12 Charisma check). |
...
| Rank | Renown | Benefits |
|------|--------|---------|
| **Springwarden** | 1 | Recognized member. You receive a supernatural gift (*charm of restoration*) when you join. Phaulkonmere serves as a safe haven: neutral ground no faction will openly violate. |
...
| **Master of the Wild** | 50 | Every party member present at Phaulkonmere receives a supernatural gift (*charm of vitality*), once per campaign. Six rangers and druids support one major operation. Beasts of CR 2 or lower perform one clearly communicated task for you if it doesn't endanger them, once per quest. |
...
| **Righteous Hand** | 50 | Six knights and two priests support one major operation. Savra convenes the Order's senior paladins and clerics for a formal investiture at the Halls of Justice; you are knighted, the title recognized by allied temples and civic authorities across the Sword Coast. If you or an ally dies in service against a fiend or undead, the Order funds one Resurrection at no cost, once. |
...
- Deliver a formal briefing with enough evidence for the Blackstaff to escalate to the Open Lord. It changes the political landscape of the campaign's final act.

| Rank | Renown | Benefits |
|------|--------|---------|
| **Gray Hand** | 1 | Recognized operative. Enter Blackstaff Tower at any hour without appointment. The Blackstaff provides one situational consumable before missions that require it: a *potion of water breathing*, *potion of climbing*, or similar. Watch officers treat you as an authorized operative and are Friendly by default. |
...
The faction rewards operatives who expand its intelligence picture and protect its embedded assets. Discretion is the primary operational requirement.

- Deliver intelligence about a rival faction's internal position or politics that the faction doesn't yet possess.
...
| **Houseless Noble** | 50 | You're named an honorary member of the faction's inner circle. An extensive intelligence network across Faerûn opens to you, with contacts from the Underdark to the Sword Coast. Dedicated sea transport and crew for any mission you undertake. |
...
The surveillance has three branches:
...
**J.B. Nevercott** (haberdasher, burgundy coat, *hat of disguise*) arrives at Trollskull Manor and maintains the fiction until he chooses to drop it. The full First Meeting scene is in the **Bregan D'aerthe** Factions guide page. Set **BD Acknowledged** when it concludes.
...
Members take on Jarlaxle's long-term goal: Lords' Alliance recognition of Luskan's reformed governance. That obligation comes due in **Vault of Dragons**, where Jarlaxle proposes returning the gold publicly in the party's name in exchange for a letter of introduction to the Alliance council. It is what he has been working toward since he arrived in the city.

## Conflicting Loyalties

The factions' interests are incompatible by design. The Lords' Alliance wants the gold returned to the city treasury intact. The Doom Raiders want Manshoon destroyed; his cell threatens their entire operation. Force Grey wants the Grand Game resolved before it spills into public view and embarrasses the city. Bregan D'aerthe wants a political favor that extends well beyond Waterdeep's walls.

A party with members in multiple factions will face these tensions as individual character obligations. When a Harper PC and a Doom Raider PC disagree about whether to hand the Stone to Mirt or protect Manshoon's rival operation, that's a character moment. Let it play as one. Treat each faction position as a real constraint on that character, give the players space to negotiate it between themselves, and resist resolving it by erasing one character's obligation. The disagreement is the texture of the campaign's second act.
...
The seven factions above are the organizations available for player characters to join. The other major powers active in Waterdeep during the Grand Game — **Xanathar's Guild**, **Manshoon's Zhentarim splinter**, and the **Cassalanters** — are adversary factions. Players may interact with, negotiate with, or broker deals with these organizations, but formal membership is not available through normal play. See **Notable Figures** for details on their leaders and agents, and **Running the Villains** (GM Guide) for how to run them at the table.
