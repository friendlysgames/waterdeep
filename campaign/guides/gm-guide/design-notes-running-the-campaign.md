...
These notes explain the structural decisions behind this remix: what the original Dragon Heist did, why it created problems at the table, and what the remix does instead. They're written for a GM who has run or read Dragon Heist and wants to understand the reasoning behind the departures, not just the departures themselves.
...
The party's real deadline is the feast, not the birthday. Stop the feast and the soul half of the buy-out fails, regardless of what happens with the gold. Let the feast proceed and ninety-nine people are already dead, regardless of whether the party later destroys the contract. The birthday is ten days away on Flamerule 1, but by then the irreversible harm has already been done.
...
That framing wastes a good character. Aurinax is a gold dragon who swore an oath to Dagult Neverember and spent years in the dark beneath a mausoleum waiting for an authorization that grows less likely every month. Neverember is publicly exiled. The office that gave him authority to bind the oath is stripped. The dragon has had a long time to think about what a promise to a corrupt man still means, and he doesn't have a clean answer.
