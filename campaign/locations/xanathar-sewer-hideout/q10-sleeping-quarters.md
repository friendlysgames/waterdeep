...
A rectangular room with straw pallets on the floor — eight of them, laid in two rows of four. Rust-stained manacles are bolted to the wall at the room's east end, four sets at chest height, the iron worn smooth with use. The bolts are secure; removing them from the wall requires a DC 16 Strength (Athletics) check or tools.
