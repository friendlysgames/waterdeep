...
The areas of the Zhentarim Warehouse have the following features unless noted otherwise.

### Levels and Elevation

Two levels. Z01 (main room), Z02 (storage closet), Z03 (secret room), and Z05 (offices) are ground level. Z04 (balcony) is an open second level overlooking Z01, accessible by a wooden staircase from the main room floor.
...
The warehouse sits at the back of a walled yard on Candle Lane. The gate is unlocked — the Xanathar raid came in fast; the Zhentarim never had time to bar it. A black winged snake is painted above the front door handle. DC 10 Intelligence identifies it as the Zhentarim symbol.

### Entry Points

Three locked entry points (DC 12 Dexterity with thieves' tools, or DC 10 Strength [Athletics] to force):

- **Front door** — facing the yard
- **Loading bay** — east side of the building; large double doors, barred from inside (DC 13 Strength [Athletics] to force)
- **Painted-over window** — west wall; glass intact, painted white on the inside
