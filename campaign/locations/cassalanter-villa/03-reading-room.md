...
The journal does not have a lock. Reading it openly: any party member may pick it up. No check required to read. The relevant entries are near the back:

> *"Neverember's dragons are an answer to our prayers."*
> *"The Cassalanter mausoleum. Inform Y.G."*
...
During day infiltration (non-event windows), the reading room may be occupied by Victoro or empty. If empty, the journal is present — same content as above. If Victoro is present: the journal is on his person or on a locked writing desk that has not yet been opened. The writing desk is not separately locked — it is just a desk.

The black dragon trophy: recognizable by any character with DC 12 Intelligence (Nature) as young adult, female, killed by a piercing weapon. The Cassalanter family crest does not include a dragon — this trophy postdates the heraldry. No mechanical function; it establishes that Victoro or an ancestor hunted dragons, a detail that reads differently once the party knows the Vault is guarded by one.
