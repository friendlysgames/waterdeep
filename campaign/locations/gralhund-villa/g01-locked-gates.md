...
**Alarm network:** The gate is included in the estate's Alarm network. Forcing it (without the key or the bypass) triggers the Alarm regardless of whether the force attempt succeeds.

**Sightlines:** From the gate, the yard (G2) is visible through the ironwork — the Coach House roofline, the near face of the manor, the guards' positions. Anyone standing at the gate is visible from G2 and G8.
