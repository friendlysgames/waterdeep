# Appendix A — NPC Roster (Working List)

Status: On hold. Roster compiled; profiles not yet written.

---

## Section Structure (~100 profiles across 16 sections)
...
- Avi
- Fala Lefaliir
- Vincent Trench (secretly the rakshasa Valantajar)
...
- Durnan
- Floon Blagmaar
- Meloon Wardragon (secretly hosting an intellect devourer; played as ally until reveal)
- Dalakhar (dies at start of Arc C; DM may need to portray posthumously via speak with dead)
...
- Barnibus Blastwind (City Watch magistrate; Arc C investigation)
- Saeth Cromley (City Watch; Barnibus's partner — NOTE: called "sergeant" here but "Watch Commander, North Ward" in Appendix D M4 and associated with magistrates in Ch2; resolve rank when writing profile)
- Jelenn Urmbrusk (Masked Lord; blackmailed by Manshoon; appears on Kolat Towers blackmail list in Arc I)

### 5. Harpers
- Mirt (moneylender; secret Masked Lord; Harper faction contact)
- Remallia "Remi" Haventree (de facto Harper leader in Waterdeep)
...
- Corvin Vayle (Harper courier server; makes Trollskull Tavern a Harper waypoint if hired; appears as Appendix F server candidate)
...
### 6. Lords' Alliance
- Jalester Silvermane (spy and Watch captain; Trollskull regular)

### 7. Emerald Enclave
- Melannor Fellbranch (Tally's brother; Enclave contact)
- Jeryth Phaulkon (Enclave contact)

### 8. Order of the Gauntlet
- Savra Belabranta (faction contact)
...
### 9. Force Grey
- Vajra Safahr, the Blackstaff (Force Grey commander)

### 10. Zhentarim — Doom Raiders
- Davil Starsong (cell leader; PC faction contact)
- Istrid Horn (lieutenant)
- Skeemo Weirdbottle (alchemist operative; traitor — feeding intelligence to Manshoon's cell from before the campaign begins)
- Tashlyn Yafeera (weapons dealer; takes over as contact when Davil is arrested after Arc D)
- Ziraj the Hunter (assassin; friends with Fala Lefaliir)
- Yagra Stonefist (Davil's bodyguard; Yawning Portal regular; appears as Appendix F bouncer candidate)
...
### 11. Bregan D'aerthe
- Jarlaxle Baenre / "Zardoz Zord" (principal; Sea Maidens Faire showman cover)
- Soluun Xibrindas (drow gunslinger; disowned for unsanctioned Dock Ward murders of elves and half-elves; carries forged BD identification token)
- Fel'rekt Lafeen (drow gunslinger)
- Krebbyg Masq'il'yr (drow gunslinger; operates as "Kreb Sorrush," Seven Masks Theater booking manager)
...
- Noska Ur'gray (enforcer; Tier 3 response team leader)
- Nar'l Xibrindas (drow mage; serves as Xanathar's advisor; secretly Jarlaxle's intelligence asset — NOTE: Appendix E Part 2 calls him a "Zhentarim mole," contradicting BD M4 which establishes him as Jarlaxle's man; resolve when writing profile; Appendix A entry follows BD M4)
- Nihiloor (mind flayer; placed intellect devourers in Meloon Wardragon and Watch clerk Orvyn Dall)
- Ott Steeltoes (dwarf; tends Sylgar — NOTE: Appendix E also describes him as a field agent captured and imprisoned in the Zhentarim Interrogation House; entry should reflect both roles when profile is written)
...
- Manshoon (principal; Kolat Towers; simulacrum complication)
- Urstul Floxin (chief field operative; drives Arc C–D pursuit)
- Sidra Romeir (lieutenant; Kolat Towers; holds teleport rings)
- Vevette Blackwater (lieutenant; coordinates strike team deployments from Kolat Towers)
...
- NOTE: Manafret Cherryport — appears in Source Guide Ch. 8 description but not confirmed in adventure-wdh.json; verify before writing profile

### 14. Cassalanters
- Victoro Cassalanter (lord; co-villain)
- Ammalia Cassalanter (lady; co-villain; drives the Founders' Day timeline)
...
- Willifort Crowelle (doppelganger butler; presents as aging male tiefling)
