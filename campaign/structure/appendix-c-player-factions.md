...
Renown is tracked as a numerical score for each faction a character belongs to, starting at 0 when they join. The five named ranks per faction unlock at **Renown 1, 3, 10, 25, and 50**. Benefits are cumulative — a character at Renown 10 retains the benefits of ranks 1 and 3.

**Gaining Renown:** Completing faction missions earns the renown listed in each mission table. Specific Grand Game actions earn the renown listed in each faction's Earning Renown section. The DM may award +1 or +2 for exceptional individual acts not covered by either category — a critical improvisation, a sacrifice made in the faction's name, a piece of intelligence that changes the campaign's direction. Major campaign-ending actions may earn +3 or +4 at once.

**Losing Renown:** Ordinary disagreements with faction members do not reduce renown. Serious offenses — betraying a mission, harming faction members, working against the faction's interests — result in renown loss at the DM's discretion. Renown cannot fall below 0. For the **Lords' Alliance specifically**: refusing or failing to complete an assigned mission without compelling justification results in formal suspension (no further missions until reinstated) or dismissal (loss of membership and all renown). The Alliance is the only faction that enforces this.

**Tracking:** If the campaign does not use numerical renown scores, the DM decides when characters advance ranks based on demonstrated loyalty and service — the Earning Renown actions serve as qualitative benchmarks rather than a score.
...
**Grand Game agenda:** The Harpers will happily allow the PCs to keep Neverember's gold. What they want is the Stone of Golorr. If the PCs hand it over, Mirt considers the debt paid in full and offers a substantial favor in return. If the PCs refuse, the Harpers become noticeably less forthcoming — but will not act against them.

### Missions

Full write-ups appear in Appendix D. Summary:
...
The Alliance's position on the Grand Game is unambiguous: the 500,000 stolen dragons belong to the city. They want the gold recovered and returned. They are also deeply alarmed by Manshoon's activities, which represent an attempt to seize control of Waterdeep's institutions from within. At campaign start, Laeral believes the vault is in Neverwinter and is unaware the Stone has resurfaced — she does not yet know all four villain factions are active. Jalester's Mission 5 (Fentree's Ledger, see Appendix D) is the mechanism that corrects her intelligence.

The Lords' Alliance is the most demanding faction in terms of professional conduct. Members are expected to behave like agents, not adventurers. Refusing missions has formal consequences — suspension or dismissal.

**Primary Contact:** Jalester Silvermane — a no-nonsense human field agent who reports directly to Open Lord Laeral Silverhand. Professional, precise, direct. Does not enjoy pleasantries and takes the work seriously.
...
- **Bring the Grand Game to Laeral's attention (+2).** Formally brief Jalester with enough evidence for him to escalate to the Open Lord. One of the most significant acts an Alliance operative can perform — triggers Laeral's direct involvement.
- **Assist the City Watch in a crisis (+1).** Aid the Watch in any situation exceeding their capacity — monsters, organized assault, mind-controlled citizens. Once per incident.
- **Expose or neutralize a Manshoon operative (+2).** Identify, capture, or eliminate a named agent of Manshoon's Zhentarim cell. Delivering a live prisoner for questioning earns the full reward; confirmed elimination earns +1.
- **Prevent an act of large-scale violence in Waterdeep (+1).** Stopping a gang war flashpoint, preventing an assassination of a public figure, or averting a mass-casualty event. Once per significant incident.
- **Recover the stolen dragons and arrange their return to the city (+4).** The Alliance's primary objective. The single highest-value act available to Alliance operatives and will elevate any character directly to the attention of the Open Lord.

### Lords' Alliance Ranks & Benefits

| Renown | Rank | Benefits |
|--------|------|----------|
| 1 | **Cloak** | Recognized operative. Watch officers treat the character as a trusted civilian informant; minor legal infractions overlooked once per tenday. |
| 3 | **Redknife** | Jalester requests a Watch escort of two **guards** for one dangerous errand per tenday. Access to Alliance safe houses in the Castle and Trades Wards. Jalester can pull a string to have minor charges dropped or a Watch report suppressed once per week. |
| 10 | **Stingblade** | Jalester arranges introduction to one named NPC in Waterdeep's political or merchant class once per arc. Alliance covers legal costs — bail, fines, damages — for one incident per arc. Access to Watch crime reports, witness statements, and active investigation files for any case in the city (classified cases require 4 hours and a DC 12 Charisma check). |
...
*"The city is built on nature. We remember that."*

The Emerald Enclave is an organization of druids, rangers, and survivalists dedicated to maintaining the balance between civilization and the wild. Their Waterdeep presence is smaller than the other factions — the city is not their natural territory — but they monitor anything that might upset the natural order of the region. A beholder crime lord building an empire in the city's sewers is exactly the kind of aberrant corruption that draws their attention.

The Enclave has no stake in Neverember's gold and will make no demands regarding the Vault or its contents. Their help is personal and magical rather than institutional, freely given to proven loyalists with no hidden agenda attached. This makes them a uniquely clean patron in the campaign — especially once every other faction is pulling in a different direction.
...
| Renown | Rank | Benefits |
|--------|------|----------|
| 1 | **Springwarden** | Recognized member. Jeryth bestows a *charm of restoration* (supernatural gift) upon joining. Phaulkonmere is available as a safe haven for the character and their companions — neutral ground no faction will openly violate. |
| 3 | **Summerstrider** | Melannor relays communications anywhere in Waterdeep or its immediate environs via *animal messenger* once per tenday. Access to Jeryth's healing spells for injuries sustained on Enclave business, cast at no cost. Melannor's network — gardeners, park wardens, harbor fisherfolk — passes environmental observations: unusual animal behavior, contaminated soil, magical disturbances. One report per ward per week. |
| 10 | **Autumnreaver** | Jeryth will cast any druid spell of 5th level or lower on the character's behalf once per arc, no components required. One trained beast — **brown bear**, **giant eagle**, or **dire wolf** — assists in one operation per arc. The Enclave provides three hidden sewer routes connecting the city to Undermountain's upper levels without passing through Watch or faction territory. |
| 25 | **Winterstalker** | Jeryth casts spells up to 8th level on the character's behalf, once per arc. Melannor accompanies the party personally on one mission per arc as a capable combat and wilderness ally. If the party knows a Beast, Plant creature, or Elemental inhabits a target location, the Enclave provides an advance intelligence report on its behavior and position; the character has Advantage on Wisdom (Animal Handling) checks and on their first Initiative roll against that creature in that location, once per use. The harbor network shares ship manifests and significant cargo movements — including Sea Maidens Faire departure schedules — automatically. |
| 50 | **Master of the Wild** | Jeryth bestows a *charm of heroism* (supernatural gift) on every party member present at Phaulkonmere — once per campaign. The Enclave mobilizes up to six rangers and druids to support one major operation. Beasts of CR 2 or lower that can understand simple instructions will perform one clearly communicated task for the character if it does not endanger them, once per arc. |

**Grand Game agenda:** The Emerald Enclave genuinely has no interest in the gold and will make no demands regarding the Vault or its contents. Their aid has no hidden strings. Characters who need a refuge, a reliable spellcaster, or one relationship in the city that isn't angling for something will find the Enclave invaluable in the campaign's later acts.
...
- **Rescue a mind-controlled or enslaved Waterdavian (+1).** Freeing a citizen from an intellect devourer, breaking a charm placed by a Xanathar operative, or liberating someone held against their will. Once per significant rescue.
- **Tithe at least 25% of a major recovered hoard to a worthy cause (+1).** Characters who do this unprompted earn the renown.
- **Refuse to participate in or cover up an atrocity, even on faction orders (+1).** Characters who hold a moral line and can explain why to Savra earn her respect in a way tactical victories cannot replicate.
...
| Renown | Rank | Benefits |
|--------|------|----------|
| 1 | **Chevall** | Recognized member. Savra vouches for the character's good faith to any temple of Tyr, Helm, or Torm in Waterdeep, granting access to healing services at cost. Temples of the Triad provide free healing (Cure Wounds at 1st level, once per day per temple) and a place to sleep. |
| 3 | **Marcheon** | Savra accompanies the party on one dangerous mission per arc as a combat-capable ally. Access to the Order's armory: borrow one mundane weapon or suit of armor per tenday at no cost. Temple priests share information about suspicious parishioners, unusual spiritual activity, and known fiendish signs in their parishes. |
| 10 | **Whitehawk** | The Order conducts surveillance on one named suspect or location per arc and reports findings within three days. A *potion of healing* and a *potion of greater healing* are provided before each major operation. One Uncommon magic item from the Armor, Ring, or Weapon category, selected for effectiveness against fiends and undead. Savra shares the Order's existing Cassalanter dossier — years of compiled observation, including a partial villa ground-floor layout and documentation of the infernal contract. Temple spellcasters of the Triad cast spells of 2nd level or lower for the character at no cost. |
| 25 | **Vindicator** | The Order will formally investigate a named individual or organization for diabolism or serious criminal activity, with findings admissible to the Lords of Waterdeep. Three paladins or clerics (use the **knight** stat block) available as a Strike Team for one operation per arc. Savra presents the character with a *+1 weapon* from the Order's reserves as a permanent gift. |
| 50 | **Righteous Hand** | The Order mobilizes a squad of six **knights** and two **priests** to support one major operation. Savra petitions the Halls of Justice to formally recognize the party as agents of the Order, granting them quasi-official legal standing in Waterdeep. If the character or an ally dies in service against a fiend or undead, the Order funds one Resurrection at no cost — once, no conditions. |

**Grand Game agenda:** The Order will move aggressively against the Cassalanters once they have solid evidence of diabolism. PCs who uncover that evidence and share it gain both renown and a formidable ally in the endgame. The tithe expectation applies to the Vault of Dragons: characters who give generously find Savra going well out of her way to support them; characters who pocket everything are quietly reassigned to less sensitive operations.
...
- **Feed intelligence on Manshoon's cell to Davil or Tashlyn (+1).** The internal war is the Doom Raiders' most pressing problem. Any confirmed information about Manshoon's agents, safe houses, or operational plans. One award per distinct piece of intelligence.
- **Neutralize a named Manshoon operative (+2).** Eliminate or capture one of Manshoon's lieutenants. Delivering a prisoner to Tashlyn earns the full renown; confirmed elimination earns +1.
- **Protect a Doom Raider commercial front from disruption (+1).** If a Black Network legitimate business is targeted by Manshoon's agents, the Watch, or a rival faction, characters who intervene earn renown. Once per incident.
- **Acquire a Golorr artifact and deliver it to Davil or Tashlyn (+2).** Delivering an Eye or the Stone itself places enormous political capital in Doom Raider hands.
- **Assist Davil after his arrest (+1).** Gathering evidence of his innocence, pressuring the right Watch captain, or arranging for a sympathetic lawyer. Any substantive effort to shorten his detention.
- **Broker a deal or alliance that benefits the Doom Raiders (+1).** Using faction membership to arrange a favorable agreement with a merchant, guild, or neutral party involving a concrete, ongoing benefit. One-off transactions do not qualify.

### Doom Raiders Ranks & Benefits
...
| 3 | **Wolf** | Davil or Tashlyn provides one piece of actionable intelligence on a rival faction's activities per tenday, drawn from the Network's informant web. Access to a Black Network safe house in the Dock Ward. Restricted goods — thieves' tools, forgery kits, disguise kits, poisons, unlicensed weapons — available through the supply chain at a 20% discount. |
| 10 | **Viper** | The Network arranges one forged document per arc — identity papers, licenses, letters of introduction — indistinguishable from genuine without magical verification. Yagra Stonefist or another Doom Raider serves as muscle (use **veteran** stat block) on one operation per arc. A Doom Raiders specialist in forgery, lockpicking, alchemy, or disguise assists on one job at no charge; after that, standard rate is 50 gp per day. |
| 25 | **Ardragon** | The Network deploys a three-person crew — two **spies** and one **assassin** — to assist in one heist or operation per arc. Davil's informants inside Manshoon's cell can be activated for specific intelligence once per arc (DC 14 Intelligence check; failure means the informant is unavailable for two weeks). Ziraj the Hunter owes Davil a favor: once per campaign, request that Ziraj neutralize one named target — captured alive or quietly eliminated. Ziraj will not take assignments he considers suicidal. |
...
- **Deliver intelligence that expands Jarlaxle's picture of the Grand Game (+1).** Any confirmed new information about a faction's Golorr artifact, lair location, or internal politics that he does not yet possess. Jarlaxle will tell the character, with characteristic courtesy, if the information is already known.
- **Acquire a Golorr artifact and deliver it to Jarlaxle (+2).** Delivering any Golorr artifact to him is the most direct service D'aerthe operatives can perform. Characters who negotiate terms before delivery may also extract additional personal benefits.
...
- **Successfully use the Sea Maidens Faire as cover or a conduit for an operation (+1).** Using the carnival ships as a meeting point, exit route, smuggling channel, or false identity source — and doing so without compromising the cover.
- **Retrieve the nimblewright shipping records from the Sea Maidens Faire without tipping off Jarlaxle's crew (+2).** A successful heist on D'aerthe's own ships, which Jarlaxle will discover and appreciate as a demonstration of capability. Characters who pull this off earn renown regardless of whether they then join the faction; existing members earn Jarlaxle's genuine delight at being robbed by his own people.
- **Impress Jarlaxle with unexpected creativity or competence (+1, DM's discretion).** A plan that is genuinely elegant, an improvisation that should not have worked but did, a social maneuver that leaves everyone at the table better off. Apply this sparingly and only when the bar is genuinely cleared.

### Bregan D'aerthe Ranks & Benefits

| Renown | Rank | Benefits |
|--------|------|----------|
| 1 | **Initiate** | Recognized D'aerthe operative. Safe house access aboard the *Heartbreaker* or *Hellraiser*. Access to drow-made equipment at cost — hand crossbows, *+1 bolts*, darkvision-enhancing gear — through Fel'rekt Lafeen. All D'aerthe members extend professional courtesy: will not act against the character without direct orders from Jarlaxle. |
| 3 | **Soldier** | Jarlaxle shares one piece of intelligence per tenday drawn from D'aerthe's embedded network — including reports from Nar'l Xibrindas inside Xanathar's own council. Access to the *Sea Maidens Faire* for cover identity support and discreet meetings. Bregan D'aerthe fences: 20% discount on black-market purchases brokered through the company. |
| 10 | **Officer** | Jarlaxle assigns a drow **spy** as a personal operative available between missions. Their loyalty is ultimately to Jarlaxle. The character gains access to D'aerthe's nimblewright shipping records — the only reliable means of tracing any construct sold in Waterdeep back to its buyer. One Uncommon magic item, personally selected by Jarlaxle because he has already read the character's intentions more clearly than they'd like. D'aerthe intelligence assessment on any faction, NPC, or location in Waterdeep on request — delivered within 48 hours, once per arc. |
...
- **Keep Laeral Silverhand's involvement in the Grand Game clean (+1).** Force Grey's value to the Open Lord lies partly in its deniability. Characters who resolve a problem without creating a political incident earn Vajra's appreciation in a way flashy violence does not. Once per arc.

### Force Grey Ranks & Benefits

| Renown | Rank | Benefits |
|--------|------|----------|
| 1 | **Gray Hand** | Recognized operative. May enter Blackstaff Tower at any hour without appointment. Vajra provides one situational consumable — *potion of water breathing*, *potion of climbing*, or similar — before missions that require it. Watch recognizes the character as an authorized operative; officers are Friendly by default. |
| 3 | **Junior Griffon** | Vajra casts one preparatory spell of up to 3rd level on the party before a mission, once per tenday: *nondetection*, *water breathing*, *see invisibility*, *speak with dead*, or similar. Access to Blackstaff Tower's reference library for arcane research. Requisition mundane equipment and Common potions from the Tower's quartermaster at no cost. |
| 10 | **Senior Griffon** | Vajra deploys one **mage** from Blackstaff Tower's staff to assist in one operation per arc. The party receives a *wand of secrets* (if not already acquired through mission rewards). City officials and Masked Lords are Friendly to the character by default. With Vajra's written authorization (DC 12 Charisma check during a non-crisis period), the character can access restricted city areas: the City of the Dead at night, sealed evidence vaults, private Watch armories. |
| 25 | **Force Grey** | Full Force Grey status. Vajra can suspend one active charge or Watch investigation against a party member at her personal authority. She casts one spell of up to 7th level for the party once per arc. One Veteran Force Grey member accompanies the party on one mission per arc for up to 7 days. An Underclock badge: the character has Advantage on Charisma checks made to influence city officials and military officers while the badge is visible. |
| 50 | **Force Grey Commander** | Vajra assigns the party operational command of a Force Grey team: four **veterans** and one **mage**, for any mission they choose. Laeral Silverhand is formally briefed on the party's contributions and extends the Open Lord's personal recognition — social and political currency with city-wide value. Vajra grants access to Blackstaff Tower's scroll vault: choose any one Rare Spell Scroll from the collection. Vajra will cast one spell of any level on the party's behalf, once. |

**Grand Game agenda:** Force Grey is allied to the Open Lord. If Force Grey members bring the Grand Game to Vajra's attention, she will inform Laeral Silverhand — and Laeral will move quickly to reclaim the 500,000 dragons. This is the most certain path to the gold returning to the city's coffers and to the party earning institutional gratitude rather than institutional pursuit. Characters who want legitimacy as their reward — a clean name, political standing, the city's formal thanks — should invest in this relationship above all others.
...
The seven factions above are the organizations available for player characters to join. The other major powers active in Waterdeep during the Grand Game — **Xanathar's Guild**, **Manshoon's Zhentarim splinter**, and the **Cassalanters** — are adversary factions. Players may interact with, negotiate with, or broker deals with these organizations, but formal membership is not available through normal play. See **Appendix A: NPC Profiles** for details on their leaders and agents, and **Appendix E: Villain Factions** for how to run them at the table.

---

## Cross-References

- **Appendix D** — Full mission write-ups for all seven factions (L2–7), per-arc faction hooks, and conflicting loyalty guidance
- **Appendix A** — NPC profiles for all faction contacts listed above
- **Appendix E** — Profiles, state tracking, response teams, and escalation for the four villain factions
- **Ch. 3 — Running the Campaign** — When and how faction recruitment happens during Arc B
- **Arc H — Sea Maidens Faire** — The conditional entry point for Bregan D'aerthe
