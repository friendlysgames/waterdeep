...
>
> This Social/Combat Event handles the G15 corridor on the night path — Floxin at the door, Orond behind it. In this Event:
>
> - Urstul Floxin (50 hp, no poison) is trying to kick down the G15b door when the party arrives.
> - Lord Orond Gralhund is barricaded in G15b and will surrender and speak under minimal pressure.
> - Orond will confirm four revelations, including the Asmodean compartment in G16 and Yalah's orders on Ches 22nd.
> - Orond in party custody is leverage against Yalah in G16 — she surrenders the Stone without a check if he is present.
> - Note: The published module places a teleportation circle and flying snakes in G15b. The Alexandrian Remix explicitly removes both. G15b is an ordinary guest room.
>
> **Trigger:** Night path, after ev-04. Party reaches the G15 corridor.
...
> **[GM]**
>
> #### What Floxin Will Not Say
>
> Floxin will not name Manshoon. Not under Intimidation, not under magical compulsion, not with a blade at his throat. He does not know the name — he knows a code and a set of dead-drop locations. The party can verify this with DC 14 Insight: he genuinely does not know who employed him. He knows the shape of the operation and the chain of command stopped at a contact he never saw face to face. Manshoon stays invisible.

### G15b — Lord Orond Gralhund
...
**Orond as leverage in G16.** If the party brings Orond upstairs when they approach Lady Yalah, she will surrender the Stone without a Charisma check; no negotiation required. Hrabbaz will stand down if she looks at him first. This is the fastest resolution path in this quest.
...
> #### Next Steps
>
> Proceed to the **The Gralhund Confrontation — Night** Event.
>
> #### Milestone: None
>
...
The guest suite corridor. Floxin at one door, Orond behind the other. Both will speak. Neither will say everything.
