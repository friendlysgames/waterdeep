...
***Three Phases, Not One Chain.*** The original WDH investigation is a sequential chain: find the nimblewright → House of Inspired Hands → detector → Gralhund Villa. One missed check severs any link. The redesign distributes each critical revelation across three independent paths so no single failure blocks progress. Phase 1 (identify the construct) is crime-scene reading. Phase 2 (find all owners) is city-scale elimination. Phase 3 (determine guilt) is convergence under faction pressure. They teach different investigative skills in sequence without being mechanically dependent on each other.
...
***The Change That Makes the Investigation Work.*** In the original WDH, Floxin is the perpetrator and is identified quickly; the investigation ends at the crime scene. The Alexandrian change — nimblewright as actor, Floxin as witness — converts a person-chase (find Floxin, done) into a systematic elimination (identify the construct, find all owners, determine guilt). The Stone being at Gralhund Villa before the investigation begins means the party races against a closing window rather than chasing a mobile target.
...
***A Character Selection That Matters.*** The Common Sign Language moment at Nim's attic is one of the rare places in the campaign where a mechanical character-creation choice produces a meaningfully different experience rather than a more efficient one. A CSL speaker does not gain better information — they gain an emotional register that Valetta's partial translation cannot carry: Nim's loneliness, its pride, its guilt, the relief of being understood. Give the player the moment. Do not rush through it to get to the detector.

***Why Not a Skill Check.*** Making CSL a persuasion modifier or a perception bonus would convert a character-creation investment into a stat bump. The design intent is that the player knows more about Nim as a character — not that the party gets a better die roll. The information accessible through CSL is narrative texture, not mechanical advantage.
...
***Frustration That Becomes Coherent.*** The Faire visit feels like a stall because it is one — the Gralhund nimblewright is not there. This is intentional. Following a real lead to a productive-but-incomplete result is exactly what good investigative fiction builds tolerance for. The payoff arrives the moment the party moves north and the detector changes behavior on Saerdoun Street. The intelligence gained at the Faire (the ledger, Jarlaxle's identity, the Cassalanter entry, the BD private meeting) makes the detour retroactively coherent.

***Jarlaxle's Conditional Activation.*** If the party reaches the Faire, Jarlaxle enters the Grand Game as an active participant and may pre-position BD agents at Gralhund Villa. If the party bypasses the Faire entirely, he remains a background presence — aware, watching, not deployed. This is not a punishment for skipping Scene 4. It is a realistic consequence of investigative depth. The party that turns over more stones gives Jarlaxle more surface to react to.
