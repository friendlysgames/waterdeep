...
The original module's day/night distinction falls out of timing rather than decision — parties don't typically understand that arriving at night triggers a fundamentally different encounter state. They feel ambushed by the raid rather than having walked into a battle they could have avoided.

This guide makes the choice visible. Faction contacts in ev-01 reference the Ches 24th deadline explicitly. The reconnaissance phase in ev-02 tells the party what each state looks like before they commit. A party that moves fast and arrives during the day gets a guarded household and a chance to extract the Stone before Floxin arrives. A party that delays gets a building already mid-battle — simultaneously more dangerous and more exploitable. Both are real options with real tradeoffs. Neither is the "correct" answer.

The optional daytime escalation elements exist because the nighttime state provides natural attrition from rival factions — Zhents and guards fight each other, Jarlaxle's drow thin the opposition, and the party navigates through the fighting rather than generating all of it. The daytime state has none of that. If a fully-equipped level 4 party enters during the day against the standard roster, the encounter may feel thin. The optional additions correct for this without changing the fundamental dynamic.
...
The daytime defense elements — animated armor, spell glyphs, proto-beholder — are sourced from community prep material and are not part of the Alexandrian Remix proper. They are included for DMs who find the standard household roster insufficient against a fully-equipped level 4 party during daytime entry.

The proto-beholder in particular requires the boss-design skill to finalize — the concept is sound but a stat block appropriate for this encounter needs proper CR math. Do not use a standard beholder. The antimagic cone at CR 13 would trivialize the party rather than challenge it.

## Aftermath as Political Machinery

The "Bad Time to Be a Zhent" crackdown and Davil's arrest are the city's direct response to what happened on Saerdoun Street — and they reshape the faction landscape for every arc that follows. The Watch's sweep removes Davil from play, puts Tashlyn in a provisional leadership role she has not asked for, and signals to every faction in the city that the Grand Game has become visible to law enforcement.
