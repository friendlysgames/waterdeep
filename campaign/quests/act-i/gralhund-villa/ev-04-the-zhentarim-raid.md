...
>
> This Combat Event covers Floxin's assault on Gralhund Villa — the backbone event of the night-path arc. In this Event:
>
> - The ten-beat raid timeline plays out with or without direct PC intervention.
> - Three factions collide: Floxin's Zhentarim, the Gralhund guards, and Xanathar's gazers observing from the perimeter.
> - Jarlaxle's BD team fires in parallel to this timeline if *Jarlaxle Informed* is set.
> - The party can enter the timeline at any beat — early arrival means fewer bodies; late arrival means more chaos and better cover.
> - This event feeds directly into ev-05 (Floxin at G15) and ev-07 (Night Confrontation in G16).
>
...
### The Ten-Beat Timeline

Each beat is approximately 1–3 minutes of real-time action inside the building. The DM drops the party into whichever beat matches their arrival.

**Beat 1 — Pantry Entry.** Floxin and three agents in black leather pick the Pantry (G6) lock. Two Zhents surprise the head butler and cook mid-liaison. The cook flees toward G5, screaming.

**Beat 2 — The Maid.** The cook's scream reaches G7. The head maid abandons her work and runs for G19. A Zhent agent chases her down on the backstairs and kills her.
...
**Beat 6 — Orond Flushed.** Lord Orond Gralhund, hearing the fighting, flees his study and runs upstairs. Floxin gives chase. A guard catches Floxin on the stairs and buys Orond twelve seconds.

**Beat 7 — Laundry Retreat.** The three guards from G7 fight their way back into G8. They are outnumbered. All three die before reinforcements arrive.

**Beat 8 — G15 Barricade.** A guard on the upper floor ushers Orond into G15b and bars the door from outside. Floxin kills the guard. He begins trying to kick the door down. This is the entry state for ev-05.

**Beat 9 — Barracks Response.** The mobilized guards from G4 pour in through G8 and G5 simultaneously. Eight veterans engage the Zhent rear guard. Five guards and two Zhents die in the first two rounds.

**Beat 10 — Stairhead Melee.** The surviving guards push to the top of the stairs. Floxin has two agents with him; the rest are dead or still fighting below. This is the operational state when the party arrives at the default night entry.
...
| Area | Dead |
|------|------|
| G6 (Pantry) | Head butler, cook (2) |
| G7 (Laundry) | Head maid (1) |
| G8 (Great Hall) | 8 house guards, 2 Zhent thugs (10) |
| G9 (Parlor) | 2 house guards — killed by Floxin before the raid when he escaped his confinement (2) |
...
|------|-------------|-------|
| G15 | Urstul Floxin (50 hp, no poison) + 1 surviving Zhent thug | Floxin trying to breach G15b |
| G15b | Lord Orond Gralhund (barricaded) | Behind wardrobe + desk + chair, armed with poker |
| G16 | Lady Yalah Gralhund + Hrabbaz | Door barred; Yalah has the Stone |
| G13 | 4 surviving house guards vs. 1–2 surviving Zhent thugs | Active melee |
| G19 | 9 commoners | Barricaded with improvised clubs; not hostile to party |
| G2 (Yard) | Hurv Taldred (shadow) + 2 mastiff-shadows | Transformed at nightfall |

### Jarlaxle's Team in Motion (Conditional — *Jarlaxle Informed*)
...
> #### Next Steps
>
> Proceed to the **The Guest Suite** Event (ev-05) to handle Floxin at G15 and Orond in G15b.
>
> After ev-05, proceed to the **The Gralhund Confrontation — Night** Event (ev-07).
>
> #### Milestone: None
>
...
> The screaming started before you were through the gate. By the time you reached the door, the first eight bodies were already cooling in the Great Hall. Two Zhentarim operatives in black leather, six house guards who almost made it to the staircase. The sound of a door being kicked in, somewhere above.

## Summary

Floxin's Zhentarim strike team entered Gralhund Villa at nightfall on Ches 24th. By the time the party reached the upper floor, most of the household guard was dead or pinned. Three factions converged on the same building with the same objective. The party moved through them.
