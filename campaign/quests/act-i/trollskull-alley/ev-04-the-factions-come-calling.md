...
>
> This Event covers faction recruitment, which runs parallel to the renovation period. In this Event:
>
...
Over the course of the renovation period, each faction sends invitations through characteristic delivery methods. Invitations are **per-character, not per-party** — the same faction may target multiple party members simultaneously, and different characters may receive different factions' invitations in the same week.

| Faction | Delivery | Eligibility |
|---|---|---|
...
|---|---|---|
| Harpers | Mirt's personal loan — 500 gp | Repayable as a favor |
| Lords' Alliance | Jalester's civic grant — 200 gp | No repayment; civic goodwill expected |
...
Seven factions sent invitations to specific party members while the renovation ran. Each invitation was delivered in a way that revealed how the faction thinks — paper bird, flying snake, Sending spell, haberdasher with no hat samples. Each offer came with renovation financing attached. Joining meant choosing, and the choices were not equivalent.
