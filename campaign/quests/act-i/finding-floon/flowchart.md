...
ev-04 — Xanathar Sewer Hideout ─────── Milestone: 1 point → Level 2
  ...
  Sewer navigation (3 DC 13 checks)
      ...
      └─ 1–3 successes → Q01 Entry
            ...
            Floon in Q07 (alive)
            Nihiloor escapes through Q11 portal (Xanathar's Lair seed)
            Q09 Peabody cellar / Q08 escape tunnel (Trollskull Alley resource)
...
Trollskull Alley — Trollskull Alley
  See: Trollskull Alley Overview for entry conditions
```
...
**Krentz continuity:** If Krentz survived ev-01, he appears in Q05 of the sewer hideout recovering from the Yawning Portal incident. His presence gives Zemk advantage on initiative (he warns him in time). This is the only cross-event mechanical consequence in Finding Floon.
