...
>
> This Event occurs when the party arrives at Trollskull Manor with the deed from Volo. In this Event:
>
...
The party arrives with deed in hand. Trollskull Alley runs north off Delzorin Street, a short block of working storefronts and residential upper floors. From the street:

**Bent Nail** (Tally Fellbranch) — a woodshop with sawdust on the threshold and a handmade sign. The door is open.

**Steam and Steel** (Embric and Avi) — a forge, smoke rising from the chimney stack, hammer sounds inside. The back gate opens onto the same shared courtyard as the manor.

**Corellon's Crown** (Fala Lefaliir) — a greenhouse with translucent glass walls, rainbow of blossoms visible from the street.

**Tiger's Eye** (Vincent Trench) — locked. Orange-and-black sign promising investigations handled discreetly.

**Book Wyrm's Treasure** (Rishaal the Page-Turner) — earthy paper smell from the propped-open door, handwritten sign in the window: *Spells for sale. Inquire within.*
...
The poltergeist of the building's last barkeeper makes himself known within ten minutes of the party's arrival. His escalation runs in three stages based on party behavior:

#### Stage 1 — Nuisance

Objects begin moving on their own. A chair slides in. A tankard lifts. A damp rag wipes a section of bar without visible hands.

If the party ignores this or responds with hostility, escalate to Stage 2.
...
> #### Next Steps
>
> The party has established what they own and what it will cost them. Broxley Fairkettle contacts them within the day to deliver the permit checklist. Proceed to **The Guild Gauntlet** Event.

## Overview

The party arrives at Trollskull Manor with Volo's deed, meets a building that needs significant work and a poltergeist with strong opinions about new ownership, and confronts the first number that defines the whole arc: 1,250 gp.

## Read Aloud

> Trollskull Alley smells like sawdust and forge smoke and something floral from the greenhouse at the end. The building on your deed is the four-story stone one with the broken weather vane on the turret. The lock on the front door is broken too. Inside: broken tables, vinegar where the wine used to be, harmless rats. The chalk slate behind the bar has someone's tab list from 1479. The brass bell above the serving hatch still rings. Within ten minutes of you walking in, the bell rings by itself.

## Summary

The party arrived at Trollskull Manor, assessed the building's state and the renovation cost, and made first contact with Lif — the poltergeist of its former bartender, who has been minding the place alone since 1479 DR and has opinions about what should happen next.
