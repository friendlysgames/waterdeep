...
>
> This Social/Exploration Event occurs when the party investigates the Sea Maidens Faire before proceeding to Gralhund Villa. In this Event:
>
...
### Arrival — The Dock Ward Distraction
...
### Captain Zord's Office

**Captain Zardoz Zord** keeps regular hours aboard the *Eyecatcher* and is known to enjoy interesting visitors. The party can arrange a meeting through the pier's harbormaster, or Zord's assistants on the docked ships will pass a message. He invites any group that asks.

Zord is Jarlaxle Baenre. He does not advertise this. The persona is impeccable — a Waterdavian carnival operator, cheerful, entrepreneurial, slightly flamboyant. He already knows about the fireball, the gnome, and the Stone. He is deciding how much to share and at what price.
...
#### Path 1 — Ask Zord (Easy, Tips Off Jarlaxle)
...
Mini-heist aboard the *Heartbreaker* or *Eyecatcher*.

**Boarding the docked ships:** DC 14 Stealth or DC 14 Persuasion/Deception to board without challenge.

**Searching accessible areas:** 30 minutes, nothing incriminating. The officer's quarters are locked.

**Heartbreaker — Partial Ledger:**
- **DC 15 Intelligence (Investigation):** Locates the officer's cabin (stateroom, aft, locked).
- **DC 16 Dexterity (Thieves' Tools):** Opens the cabin.
- Inside: folio of waxed vellum pages, nine rows, seven excised with a blade. Two rows remain (NW-01: Summertaen; NW-05: [excised], Yellowspire). The partial ledger confirms the network exists but does not name the Gralhunds.

**Eyecatcher — Complete Ledger:**
- Access: harbor skiff (2 sp, hourly departure from the harbor steps), swim (DC 12 Athletics, cold water), clandestine night approach (DC 14 Stealth to reach hull; DC 16 to board unseen), or credible cover story with Zord's invitation (DC 16 Deception without one).
- **DC 18 Intelligence (Investigation):** Locates the ledger in Zord's private office.
- See ledger table below for full contents.

**Consequence:** Jarlaxle discovers the theft within 24 hours but cannot identify who. He does not deploy to Gralhund Villa.

#### Path 3 — The Crystal Ball (Hardest, Maximum Intelligence)

The *Scarlet Marpenoth* — whose brass model stands in the House of Inspired Hands main hall — is a Lantanese submersible docked beneath the *Eyecatcher* via a keel collar.

**Discovering it:** DC 18 Wisdom (Perception) from the docks at night, looking at the water under the *Eyecatcher's* hull. Alternatively, a faction tip (Melannor's Castle Ward disturbance report, cross-referenced with the Faire visit, yields nothing specific; this path requires Zord to mention it or active underwater scouting).

**Accessing it:** Swim beneath the *Eyecatcher* at night (DC 14 Athletics, cold harbor water, awkward current against the keel collar seal), or locate the keel hatch from inside the ship (DC 16 Investigation in the *Eyecatcher*'s lowest deck).
...
**Partial Ledger** (Heartbreaker, two surviving rows):
...
**Complete Ledger** (Eyecatcher, or given directly by Jarlaxle to BD members):
...
**Renown:** +1 for sharing intelligence back with BD; +2 for withholding. Jarlaxle is genuinely delighted to be outmaneuvered by his own people.
...
The Sea Maidens Faire's fleet carried multiple nimblewright signals — the Gralhund unit wasn't isolatable from the pier. But the ships held something more useful: the seller's records, Jarlaxle Baenre behind the Captain Zord persona, and three paths to the Gralhund name and address.
