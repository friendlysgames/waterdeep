...
>
> This Exploration/Social Event begins in the Castle Ward sewers and resolves based on which approach the party chooses. In this Event:
>
> - Nar'l's hostile initial attitude is a real obstacle — persuading him to engage is required before any resolution option is available.
> - Three resolution options produce three meaningfully different campaign states. Each produces exactly one True flag and two False flags.
> - Krebbyg's explicit instruction is that Nar'l stays alive and in place if possible. A party that kills Nar'l has acted against the mission brief; the Eliminated flag records this and the renown consequences follow.
> - After resolution, Jarlaxle acknowledges the mission with a private dinner at Seven Masks — in person, as Zardoz Zord, for the first time since the party became operationally trusted.

**Background (DM only)**

**Nar'l Xibrindas** is a drow mage who serves as Xanathar's advisor and secretly reports to Jarlaxle by *Sending* spell every three days. He has been in place for three years. His intelligence on the panopticus surveillance routes and the lair's internal layout is Jarlaxle's single most valuable source.

Nar'l's cover has been degrading for two months. He learned that his brother **Soluun Xibrindas** was operating in Waterdeep under a forged Bregan D'aerthe token — unauthorized, disowned, and conducting operations that were beginning to attract Guild attention. Nar'l has been intercepting internal reports that mentioned unusual drow activity in the Dock Ward, suppressing information before it reached Xanathar's direct attention. The gaps in his summary reports were inevitable.

**Ahmaergo**, Xanathar's loyal taskmaster, flagged the gaps two months ago and has been building a case. He has not yet formalized it into a request for Nihiloor interrogation. If he does, the situation becomes irreversible — Nihiloor does not investigate politely.

Krebbyg's instruction to the party before they leave: "He stays alive and in place if possible. He is more valuable there than anywhere else." This is the mission's constraint, not a suggestion.

### The Castle Ward Sewers
...
Three approaches are viable. The party chooses one.

**Option A — The False Report**
...
Get Nar'l out of Xanathar's lair before anyone notices he is gone. He returns to collect what he can carry — one hour — then transits the Castle Ward tunnels at a pre-agreed time. The party holds the tunnel entrance against two Guild sentries who are aware of unusual activity in the sewer system.
...
On full success: Xanathar's internal investigation closes, Nar'l returns to full standing with the beholder, and Jarlaxle regains a clear intelligence channel. On partial success (one failed check): the investigation closes, but Ahmaergo makes a note of the anomaly — a second attempt on Nar'l is more likely in the future. On failure: the insertion is detected and the party must extract before the outer org identifies them.
...
Jarlaxle's deepest asset inside Xanathar's Guild is compromised. The party finds him in the sewers and decides whether to cover for him, extract him, or eliminate the threat another way.
...
The party reached Nar'l Xibrindas through his Castle Ward sewer contact protocol and convinced him to engage despite his initial hostility. He confirmed that he had been covering for his brother Soluun's unauthorized presence in Waterdeep. The party chose a resolution — false report, extraction, or source discrediting — and Jarlaxle acknowledged the mission with a private dinner at Seven Masks, in person, as Zardoz Zord.
