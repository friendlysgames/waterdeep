...
>
> This Social Event fires two days after the party exits **Gralhund Villa**, for Doom Raiders members only. In this Event:
>
> - The Watch's city-wide Zhentarim sweep catches Davil Starsong on association — held at Castle Waterdeep, not charged, pending Lords' questioning.
> - A flying snake delivers Tashlyn Yafeera's first message to the party.
> - Within forty-eight hours, Tashlyn arranges a brief meeting: her proper introduction, cold and operational.
> - The party may work toward Davil's release, earning renown if they succeed.
> - Tashlyn takes over all mission briefings until the **Davil's Return** Event (s02).
...
A black flying snake arrives at wherever the party is staying. It carries a small scroll in neat, controlled handwriting. The message is unsigned.

> > "Davil is unavailable. Continue normal operations. Await further contact."

Four words of cover. Zero words of comfort.

> [!profile]**Who Is Tashlyn**
> **Tashlyn Yafeera** is the Doom Raiders' Master of Arms and Mercenaries. She serves as Captain of the City Guard at the South Gate under a dwarf magister named Vorondar Levelstone — a cover position she has cultivated over two years. Her intelligence on Manshoon's cell is sharper than Davil's because she has spent a year building sources inside the Splinter rather than business contacts in the Trades Ward. She communicates exclusively by flying snake and expects inference rather than explanation.
>
> She introduces herself by name at the meeting described below.

### Tashlyn's Introduction

Within forty-eight hours, a second flying snake arrives. This one carries a time and a location.
...
She doesn't say what that means. She'll contact the party when she's decided how much to trust people who walked into a noble's estate and started a war.
...
Any one of these approaches counts. Multiple approaches in combination improve the odds and speed the release, but each requires real effort, not just coin.
...
Record whether the party made a substantive effort to shorten Davil's detention — gathering evidence, pressuring a Watch captain, or arranging legal representation. If True, Davil knows when he returns. Read by **Davil's Return** (s02, tone of Davil's acknowledgment) and the **Doom Raiders** factions guide renown table (+1 renown on award).
...
Two days after Gralhund Villa, the Watch's Zhentarim sweep catches Davil Starsong on association and holds him at Castle Waterdeep. Tashlyn Yafeera sends word, then arranges a meeting — cold, brief, operational. She's the contact now, and the cell continues.
...
Two days after Gralhund Villa, the Watch's city-wide Zhentarim crackdown caught Davil Starsong on association. Tashlyn Yafeera sent the first message, then introduced herself in person: cold, operational, and clear about the difference between herself and Davil. She is the contact now.
