...
He gives the decanter a half-turn before setting it down.
...
> ***Persona.*** To the world, Davil is the Master of Opportunities and Negotiations: a sun elf who makes friends easily, negotiates deals with grace even while drunk, speaks with a lilt he attributes to his elven heritage, and wears a charm bracelet hung with small trophies from monsters the Doom Raiders have killed. To those he trusts, he is a retired adventurer who frames the whole enterprise as helping people in need. Deep down, he withholds explanation and lets things sit, showing interest without revealing why.
>
> ***Morale.*** In a fight, Davil attempts negotiation first, fights with a swashbuckler's precision second, and retreats to preserve the Doom Raiders' leadership structure third. After his arrest and return, he fights more deliberately.
>
> ***Relationships.*** Davil is the cell leader of the Doom Raiders, the faction contact for Zhentarim-aligned PCs, a permanent resident at the Yawning Portal, colleague of Istrid, Tashlyn, Ziraj, and the traitor Skeemo Weirdbottle.

### Concluding the Event

#### Doom Raiders Joined: True / False

Recorded when the party answers Davil's offer — or returns to answer it before **Trollskull Alley** ends. True means they accepted faction membership. False means they declined or deferred without returning. This flag is read by every Doom Raiders faction mission and by the **Davil's Arrest** standalone event.

> **[GM]**
>
> #### Next Steps
>
> If **Doom Raiders Joined** is True, Davil acknowledges the decision simply and moves on to practical matters. He introduces Istrid Horn's lending terms and notes that Tashlyn Yafeera will be in touch. The **Dockside Killer** mission (DR-M01) is available immediately.
>
> If **Doom Raiders Joined** is False, Davil nods and refills the decanter. He doesn't close the door aloud. If the party changes their minds before **Trollskull Alley** ends, they can find him in the same room at the same time most evenings.

## Overview

A flying snake delivered a note to Trollskull Manor: Davil Starsong wants a word at the Yawning Portal. Yagra Stonefist was already at the bar when the party arrived.
...
The party met Davil Starsong, cell leader of the Doom Raiders, in his curtained room on the second floor of the Yawning Portal. He explained the split between his cell and Manshoon's Zhentarim without being asked, described what the faction offers, and told the party what it asks in return. He did not press for an answer that night.
