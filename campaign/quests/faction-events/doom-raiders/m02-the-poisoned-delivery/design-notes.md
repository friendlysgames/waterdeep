# Design Notes: The Poisoned Delivery

## Skeemo's First Appearance

***The party meets the traitor before they know he is one.*** This is the party's first encounter with Skeemo Weirdbottle, and it is intentionally uncomfortable. He is correct, polite, and answers questions with deflections that are technically reasonable. He does not do anything provably wrong in this scene. He hands over a coffer he did not fill, from behind a counter full of legitimate stock, and watches the party leave.

The mission is designed to let the party notice something is off without forcing the revelation. The coffer's warmth and wrong smell are detectable; the poison requires breaking a seal the party was implicitly told not to break. A party that investigates anyway and says nothing teaches Skeemo that they are perceptive and controlled — a more useful party than one that delivers blind and a more dangerous one than one that reports back immediately. All three responses go into his intelligence file.

When Mission 4 arrives and Tashlyn names Skeemo as a traitor, the party has a specific scene to look back at. The design note in Mission 4 addresses how to play that retrospective recognition.

## Gaxly Rudderbust Cross-Faction Note
