...
>
> This Investigation/Social Event begins when Vajra presents the pattern in the reversed rulings. In this Event:
>
> - Three independent investigation paths confirm the possession: the rulings pattern, behavioral surveillance, and the apartment coded ledger.
> - Extraction has three options: private arrangement at the apartment, through Vajra's Blackstaff authority, or the controlled surrender method.
> - The extraction must not trigger a Watch investigation touching the Network.
> - Orvyn, restored, names two Guild representatives and files an amended report.
> - The coded ledger is a secondary reward — physical evidence of the network's self-sustaining architecture.
...
Three independent observations, any of which confirms the possession. The party does not need all three; two is sufficient for Vajra to use her Blackstaff authority.

**The rulings pattern:** The three reversed decisions are accessible at the public appeals registry in the Hall of Records. A **DC 14 Intelligence (Investigation) check** examining them as a group identifies a fourth reversal — one quietly re-reversed two days later. The correction is in Dall's handwriting when the original reversal is in a magistrate's. He filed a correction to something he should not have been able to correct. The devourer made a mistake and fixed it.

**Behavioral surveillance:** Watching Dall over three days during his lunch at the Bricklayer's Cup or from the precinct street. A **DC 14 Wisdom (Perception or Insight) check** during the lunch observation catches: he eats with the flat, methodical pace of someone who is not tasting their food; his eyes track the precinct door rather than the room; when a colleague greets him by name, his reaction lags by a half-second before he smiles. The party learned these tells in Mission 3 — a character who was observant during the Meloon surveillance has Advantage on this check.

**The apartment:** Orvyn's apartment is on Tallow Court. In a locked drawer of his writing desk — **DC 13 Dexterity (Thieves' Tools)** — is a small coded ledger that Nihiloor's operation has been using him to maintain. A list of cases being influenced and why. Orvyn is not writing it consciously; the devourer maintains it automatically. Decoding it requires **DC 12 Intelligence (Investigation)** — a simple notation cipher, and the entries are evidence on their own.
...
The Guild representatives he names become Watch targets. It is not immediate — the Code Legal moves slowly — but the names are now in a report with the Blackstaff's tacit backing.

### Concluding the Event

> **[GM]**
>
> **+2 Renown if** Orvyn Dall is extracted and restored without triggering a Watch investigation that touches the Network. Nihiloor's legal apparatus thread is severed cleanly.
> **+1 Renown if** the coded ledger is recovered and delivered to Vajra. It becomes evidence in Force Grey's ongoing Nihiloor dossier — confirmation that the network has self-running assets that survived the Spawning Pool's destruction.
> **+1 Renown (supplementary) if** the two Guild representatives Orvyn names are reported to Jalester Silvermane (Lords' Alliance) as well as Vajra. The cross-faction intelligence share is the kind of discretion Vajra notes in the positive column.
...
Three Watch magistrates have reversed significant rulings. All three benefit the same Guild interests. Vajra wants the thread investigated and, if confirmed, cut.
...
>
> There is a short dossier on the desk when you arrive — three names, three reversed decisions, one correlation: a clerk named **Orvyn Dall**, whose office processed all three magistrates' paperwork. Vajra is standing at the standing desk.
>
> > "Nihiloor's network lost its Spawning Pool. It did not lose everything. If there is a devourer in the Watch's legal apparatus, I need it removed before it becomes embedded in something I cannot reach." A pause. "I cannot use Blackstaff authority here without triggering a review I am not ready to trigger. You are not the Blackstaff."

## Summary

Vajra assigned the party to investigate a pattern of reversed Watch rulings connected to a single appeals clerk, Orvyn Dall. Three independent investigation paths confirmed an intellect devourer possession — a self-sustaining Nihiloor legacy asset that survived the Spawning Pool's destruction. The party extracted and destroyed the devourer, and Orvyn was restored. He named two Guild representatives who had improper precinct access. Vajra received both the coded ledger and the restored clerk's report.
