...
>
> This Social Event fires when the party requests an audience with Vajra Safahr and can demonstrate a complete Grand Game picture (see **What Counts as the Full Picture** below). In this Event:
>
> - The party briefs Vajra on all four competing factions, the Stone of Golorr, the vault's contents, and at least one active deadline.
> - Vajra listens without interrupting. She confirms three items she independently verified. She corrects one assumption about the vault's location.
> - The Blackstaff shifts once during the briefing, without anyone touching it, when the vault figure is named.
> - When the briefing is complete, Vajra goes still for longer than is comfortable, then reaches for a pen and begins writing a sealed message to Laeral Silverhand.
> - The party earns **+2 renown** with Force Grey — the single most consequential act a Gray Hand can perform.
>
> This event fires no earlier than the first completed lair heist. The party must be able to name all four villain factions with specific evidence for each to qualify.

**Background (DM only)**

Vajra has been assembling her own partial picture for months. She knows Xanathar's mind-control operations better than anyone else on the surface — Nihiloor's intellect devourer program is her standing first priority. Through Hlam's intelligence she confirmed an archmage at Kolat Towers; she does not yet have the name. The Stone's reappearance she inferred from arcane residue patterns in three separate Watch incident reports that the Watch itself did not know were connected.

What she does not have is the full political picture: four factions simultaneously active, pursuing the same objective through incompatible methods, centered on a vault that has been missing from Waterdeep's treasury accounts for years. That is the piece the party provides.
...
The event fires only when the party can demonstrate all four of the following:

**The Four Factions.** The party names all four competing interests — Xanathar's Guild, Manshoon's Zhentarim (the Splinter), House Cassalanter, and Bregan D'aerthe — and explains what each faction wants from the vault and how each is pursuing it. Evidence need not be documentary. Vajra weighs credible testimony from operatives who have been inside the relevant operations.
...
If the party presents three of the four elements, Vajra acknowledges what they have brought and asks one direct question to identify the gap. She does not reward an incomplete briefing with the full renown or begin writing to Laeral.

### Arriving at Blackstaff Tower

Force Grey members at Renown 1 or higher have standing access to Blackstaff Tower at any hour. Non-members must be vouched for by a Gray Hand or higher. Any party member can send a message through Blackstaff Tower staff to request an audience; if the party has reached the threshold for this event, Vajra acknowledges within the hour.
...
The Blackstaff is quiet.

### The Briefing

As the party lays out the Grand Game picture, Vajra listens. She writes occasional notes on the paper in front of her and does not interrupt.

She confirms three items without prompting — she already had this intelligence and the party's account matches her records, which is how she establishes they are reliable:

- Nihiloor's presence inside Xanathar's lair and the ongoing intellect devourer program
...
She begins writing a sealed message. When she finishes, she does not close it immediately.

> > "Laeral needs to know the full scope to act effectively. She will move quickly when she does. Keep your operations quiet until she engages — you don't want to be standing between the Open Lord and four factions when she does."

She seals the message.

> > "This was the most consequential thing you could have brought me. I am aware of that. So are you."

The door opens by itself.

The party earns **+2 renown** with Force Grey for delivering a complete Grand Game picture. This is the highest single-act renown in the faction and is awarded once in the campaign.
...
>
> > "Laeral needs the full scope to act effectively. She will move quickly when she does."
>
> She seals the message without looking up.
>
> > "This was the most consequential thing you could have brought me."

## Summary

We gave Vajra the complete picture at Blackstaff Tower: all four factions, the Stone, the vault, the deadline. She listened without interrupting, confirmed three pieces of intelligence we had not expected her to already have, and corrected our assumption about where the vault sits. When we finished, she went still for longer than was comfortable. Then she reached for a pen and wrote a sealed message to Laeral Silverhand. She said the Open Lord will move quickly when she knows the full scope. We left before the Tower closed the door behind us.
