...
>
> This Exploration Event begins when Melannor summons the party in person. In this Event:
>
> - Gerrick's drainage tunnel entry in the southern Undercliff has been recently used from the other side.
...
The drainage tunnel entry in the south Undercliff terraces: a bricked archway, iron grate fitted in place. The grate shows signs of recent passage from the other side — scratched iron around the seal, rust disturbed at the hinges, earth moved inward.

Inside: a long brick-lined tunnel running east, wet and cold. After 200 feet it opens into the Castle Ward cistern access — a larger vaulted space with three channels running in different directions. The mineral smell of still water is present through the whole descent.

### The Contaminated Channel

A DC 12 Wisdom (Survival) or Intelligence (Investigation) check identifies the problem. The eastern channel has an oily iridescent film on the water surface. The smell is wrong — faintly chemical, with a quality a character proficient in Arcana identifies as thought-residue, the signature of psychic waste. Extended exposure in the contaminated section (more than 10 minutes) imposes the Dazed condition until a Short Rest.

Following the film upstream leads east toward a sealed side-chamber: a fitted stone in the cistern wall, recently moved and replaced.
...
With the cache destroyed and the source sealed, Jeryth can clear the channels — but she needs a conduit into the cistern system. Melannor provides a cutting from Phaulkonmere's herb beds when the party returns to report. He holds it out with the care of someone handing over something irreplaceable.

Carrying the cutting into the contaminated eastern channel and placing it in the water gives Jeryth a path. She concentrates through it for 10 minutes. The smell of rain and turned earth fills the cistern for an hour. The iridescent film dissipates. The water clears.

When the party returns to Phaulkonmere that evening, the herb beds are restored. Jeryth speaks once:

> > "The water remembers what was put into it. So will I."
...
>
> **Emerald Enclave Mission 6 — The Dreamer's Reach** becomes available when the party reaches Renown 12 and 7th level.
>
> #### Milestone: None
>
...
Phaulkonmere's herb beds are dying overnight, and the source is in the Castle Ward cisterns.
...
The party descended through Gerrick's drainage tunnel into the Castle Ward cisterns and traced a psychically-resonant contamination to a Manshoon Splinter cache. They destroyed the cache, recovered a coded logbook naming Raeve Solnath as the operation's coordinator, and completed a purification ritual that cleared the channels and restored Phaulkonmere's herb beds that evening.
