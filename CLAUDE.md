...
> **Start every session by reading the most recent `session N handoff.md` in the root directory (highest N — currently `session 23 handoff.md`).** It records completed work, standing decisions, outstanding tasks, and exactly where to pick up next. Do not re-derive or re-ask anything it already settles.
...
| `campaign/structure/ch1-beginning.md` | **RETIRED** — superseded by modular files in `campaign/guides/players-guide/` and `campaign/guides/gm-guide/`. |
| `campaign/structure/ch2-city-of-splendors.md` | **RETIRED** — superseded by modular files in `campaign/setting/` and `campaign/setting/villains/`. |
| `campaign/structure/ch3-running-the-campaign.md` | **RETIRED** — superseded by modular files in `campaign/guides/gm-guide/`. |
| `campaign/guides/players-guide/about-this-campaign.md` | Players' Guide — three remix pillars, campaign concept, who it suits. Structuring draft. |
| `campaign/guides/players-guide/character-creation.md` | Players' Guide — general guidance, species notes, all XPHB + FRHoF backgrounds rated for Waterdeep fit. Structuring draft. |
| `campaign/guides/players-guide/debts-of-the-city.md` | Players' Guide — all 8 Debts (flavor + "Your character knows" only; no Holder sections). Structuring draft. |
| `campaign/guides/players-guide/bonds-and-flaws.md` | Players' Guide — Bonds table (d8) and Flaws table (d8) with arc connections. Structuring draft. |
| `campaign/guides/players-guide/faction-affiliations.md` | Players' Guide — faction preview table, BD conditional entry, Two Zhentarims note. Structuring draft. |
| `campaign/guides/gm-guide/about-this-campaign.md` | GM Guide — superset of player version; includes DM private notes on deaths, sympathetic villains, tone. Structuring draft. |
| `campaign/guides/gm-guide/session-zero.md` | GM Guide — full session zero script: campaign pitch, gold question, contract, safety tools. Structuring draft. |
| `campaign/guides/gm-guide/debts-of-the-city.md` | GM Guide — superset of player version; includes all Holder guidance, Warning callouts, Design Note. Structuring draft. |
| `campaign/guides/gm-guide/adventure-summary.md` | GM Guide — four-act overview table, dramatic arc per act, milestone pacing notes. Structuring draft. |
| `campaign/guides/gm-guide/structural-rules.md` | GM Guide — Two Zhentarims, faction response teams, festival calendar, Three Clue Rule, fireball victim, faction state tracking. Structuring draft. |
| `campaign/guides/gm-guide/grand-game-in-play.md` | GM Guide — starting faction knowledge, escalation tiers (1–5), inter-faction conflict, when factions back down. Structuring draft. |
| `campaign/guides/gm-guide/player-factions-overview.md` | GM Guide — six standard factions + Bregan D'aerthe unique mechanic; conflicting loyalties overview. Structuring draft. |
| `campaign/guides/gm-guide/design-notes-running-the-campaign.md` | GM Guide — macro design notes: simultaneous villains, heist framework, distributed Eyes, manor, fireball, Founders' Day, Jarlaxle conditional, gold resolution, Aurinax. Structuring draft. |
| `campaign/setting/waterdeep-lore.md` | Setting — wards, governance, guilds, religion, festival calendar, dragonward. Structuring draft. |
| `campaign/setting/history.md` | Setting — 8-era narrative history: Ahghairon through the players' arrival. Structuring draft. |
| `campaign/setting/grand-game.md` | Setting — in-world Grand Game frame: how information moves, faction starting knowledge table. Structuring draft. |
| `campaign/setting/villains/xanathar.md` | Setting — Xanathar character document: 3 personality phases, relationships, goals, Sylgar note. Structuring draft. |
| `campaign/setting/villains/manshoon.md` | Setting — Manshoon character document: 3 phases (incl. Simulacrum), relationships, goals, Two Zhentarims DM note. Structuring draft. |
| `campaign/setting/villains/cassalanters.md` | Setting — Cassalanters character document: 3 phases, relationships, goals, children timing note. Structuring draft. |
| `campaign/setting/villains/jarlaxle.md` | Setting — Jarlaxle character document: Zardoz Zord phase + adversary/ally tracks, relationships, goals, conditional entry note. Structuring draft. |
