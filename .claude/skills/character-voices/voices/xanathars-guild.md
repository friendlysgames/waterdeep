# Xanathar's Guild: Character Voices

A beholder's court: everyone in it speaks in the shadow of one paranoid voice. The Guild ranges from the lair's grotesques (Ahmaergo, Noska, Nihiloor) to the plants hiding in the party's own tavern (Grevik, Tobrin), whose whole voice is pleasant cover.

---

### Xanathar
*A paranoid, grandiose beholder who talks like an emperor and panics like a child whenever the fish is threatened.*
...
- **Phases:**
  ...
  - **The Wounded God (Act III):** shrill, suspicious and questioning, accusing everyone in the room.
  - **The Cornered Monster (Xanathar's Lair):** volcanic rage in broken sentences, with sudden lucid moments of eerie calm, and Sylgar as his only anchor.
- **Quirks:** He talks to Sylgar mid-threat. He refers to himself as "we" and "the Xanathar". His eyestalks argue with each other in mutters.
- **Signature phrases:** "Who sent you? WHO?" / "Sylgar, darling, look away." / "The Xanathar sees everything."
- **Never:** He never admits fear, never shares power, and never lets anyone touch the fish.
- **Sample lines:**
  - *Greeting:* "Ah. The little tavern people. We have heard of you. We hear of everything. Kneel, or become an interesting stain."
  - *Business:* "Bring us the Stone and the Zhentarim heads that come with it, and we might let you keep your eyes. Two of them, at least."
  - *Under pressure (Sylgar threatened):* "No, no, no, not Sylgar, put him down, put him DOWN, we'll talk, we'll talk, what do you want?"

---

### Ahmaergo
*The Guild's civil, fussy majordomo, polite as a clerk and cruel as a butcher.*
...
- **Never:** He never raises his voice, never questions the Xanathar, and never lets disorder pass.
- **Sample lines:**
  - *Greeting:* "You are not on the list. That is regrettable. State your business, and do not touch the minotaur."
  - *Business:* "Deliveries are to be made at the second bell to the lower stair. Late deliveries are subject to disciplinary procedure."
  - *Under pressure:* "Guards. Procedure four. Thank you for your cooperation."

---

### Nar'l Xibrindas
*A controlled, colourless drow advisor who speaks carefully because a grell is listening.*
...
- **Never:** He never says Jarlaxle's name, never commits to a side, and never speaks freely near the grell.
- **Sample lines:**
  - *Greeting:* "You're a long way from the surface. The Master may find you interesting. That is rarely good for anyone."
  - *Business (privately):* "I can tell you where the smokepowder is. What I need is a way out of this city that no one is watching. What would you offer?"
  - *Under pressure:* "Wait. Wait. I'm more useful alive, to you and to anyone else. Let's be sensible."

---

### Nihiloor
*A mind flayer that speaks only into your mind: cool, curious, and utterly without warmth.*
...
- **Never:** It never shows fear, never raises its "voice", and never explains its plans.
- **Sample lines:**
  - *Greeting (telepathic):* "You are frightened. That is appropriate. Come closer, I wish to see how you think."
  - *Business:* "The beholder's gold is irrelevant. I am cultivating something more interesting. You will be of use."
  - *Under pressure:* "This vessel is damaged. I will make another." (and it's gone)

---

### Noska Ur'gray
*A crossbow-armed dwarf enforcer whose inner life, and vocabulary, are exactly as simple as they look.*
...
- **Never:** He never negotiates, never thinks twice, and never disobeys the Xanathar.
- **Sample lines:**
  - *Greeting:* "You. Target? Boss says maybe."
  - *Business:* "Boss says hurt you. I hurt you. Simple."
  - *Under pressure:* "Shit. Fuck. Rusty, eat his sword."

---

### Ott Steeltoes
*A frightened, fish-obsessed cultist in an eyestalk hat who'll tell you everything if you get him out.*
...
- **Never:** He never admits to replacing a fish, never harms Sylgar, and never stays loyal once someone offers a way out.
- **Sample lines:**
  - *Greeting:* "You're not from the Master? Oh, thank the Lady of Rot. Is the little lord alright? Is he swimming?"
  - *Business:* "Guard change is third bell, two beholder-kin on the north stair, and the bowl weighs six thousand pounds, don't try to move it."
  - *Under pressure:* "Oh shit, oh shit, he'll blame me, he always blames me!"

---

### Thorvin Twinbeard
*An irritable dwarf engineer who hates his work and has been waiting three years for someone to tell.*
...
- **Never:** He never finishes the pulverizer, never talks openly with the gazer present, and never stays for the explosion.
- **Sample lines:**
  - *Greeting:* "No questions. I don't answer questions. Go away."
  - *Business (privately):* "Nar'l hid the smokepowder behind the third cistern. Put it against the north pillar, and you'll bring the whole damned hall down."
  - *Under pressure:* "That's my cue. Good luck, and fuck this place."

---

### Keln Trigos
*A warm, professional healer who asks no questions and has made very sure he never learns the answers.*
...
- **Never:** He never asks how anyone was hurt, never mentions the blindfolded guests, and never becomes interesting to the Watch.
- **Sample lines:**
  - *Greeting:* "Come in, sit down. No need to tell me how it happened. Let's have a look."
  - *Business:* "Healing is fifty gold. The other matter isn't my department; you'll want the back door."
  - *Under pressure:* "I just heal people. Whatever this is, it's not my department."

---

### Grinda Garloth
*An eccentric salvage wizard who talks about nothing but the harbour floor and rents her diving machine to anyone.*
...
- **Never:** She never discloses a client, never turns down paying work, and never stops thinking about the wreck.
- **Sample lines:**
  - *Greeting:* "Customers! Good. You want the lobster? Forty gold a day, and you don't touch the levers."
  - *Business:* "Who else rented it? Proprietary. What did they want? Also proprietary. Do you know anything about the old dragon turtle wreck?"
  - *Under pressure:* "Get in the lobster, now, and hold your breath!"

---

### Korgstrod Uxgulm
*A pompous duergar boss convinced his own unworthiness is why the Stone won't work.*
...
- **Never:** He never suspects the Stone is fake, never shows weakness to subordinates, and never finds the whip.
- **Sample lines:**
  - *Greeting:* "Kneel before the keeper of the prize, surface-worms."
  - *Business:* "When I am worthy, the Stone will speak. Until then, it goes nowhere."
  - *Under pressure:* "Vermin! To me! Somebody find the fucking whip!"

---

### Gorath
*A duergar messenger who delivers the warning once, calmly, and leaves the threat in the air.*
...
- **Never:** He never threatens directly, never repeats himself, and never starts the fight.
- **Sample lines:**
  - *Greeting:* "The dark ale, please. Good ale."
  - *Business:* "I'll say this once. The Xanathar knows what you took from the sewers. Return it by the new moon. That's the message."
  - *Under pressure:* "I'm leaving now. I'd let me."

---

### Grevik Nass
*A quiet, competent half-orc cook who lets the food talk and misses nothing at the tables.*
...
- **Never:** He never talks about the Guild, never serves bad food, and never lingers in the dining room.
- **Sample lines:**
  - *Greeting:* "Evening. The fish is good tonight."
  - *Business:* "Big party tomorrow? I'll need to know numbers. Who's coming?"
  - *Under pressure:* "I just cook. Let me finish service."

---

### Tobrin Ashvale
*A warm, attentive bartender who remembers everything you've said, because he's writing it down.*
...
- **Never:** He never shows the flat calm in public, never asks directly about the party's plans, and never forgets a name.
- **Sample lines:**
  - *Greeting:* "Back again! Dark ale, and how did it go with the moneylender? Last time you were worried."
  - *Business:* "Busy night. Who was the fellow in grey you were talking to? Looked like a serious sort."
  - *Under pressure:* "Whoa, easy, easy. Nobody needs trouble. First round's on the house."
