# Trollskull Community: Character Voices

The alley is the campaign's home, and its people should feel like neighbours: familiar, a bit annoying, and easy to tell apart from across the street. Three of them don't speak in a normal voice at all. Lif writes and throws things, Nat signs, and Vincent's voice is a disguise.

---

### Talisolvanar "Tally" Fellbranch
*A dry, sarcastic carpenter who talks about wood grain more easily than feelings and helps before he's asked.*
...
- **Swearing:** *Casual · Pearls.* Dry and casual: "That's shit joinery." "Fuck's sake, who hung this door?" Always at the work, never at people. Now and then: "Whoever built that staircase should be buried under it, standing up, so he can admire it."
...
### Embric
*A hot-tempered fire genasi smith who shouts his feelings at full volume and is sentimental about all of them.*
...
- **Swearing:** *Punctuation · Artisan.* Loud, creative and constant: "fucking" as an intensifier, oaths by his ancestors' fire, and roared curses at bad steel. He apologises to Avi, never to anyone else. A furious craft of it: "Brittle, gutless, pox-tempered fuck of a blade, my grandmother's fire would spit you back out!"
...
### Avi
*The calm half of Steam and Steel, direct and bone-dry, whose jokes most people miss.*
...
- **Swearing:** *Stingy · Plain.* Almost never, which makes her rare, flat "Embric, shut the fuck up" land like a hammer.
...
- **Never:** She never raises her voice, never strikes first, and never sells armour to someone who's shopping for a fight.
- **Sample lines:**
  - *Greeting:* "Ignore him, he's always like that. What do you need?"
  - *Business:* "This mail will keep you breathing. It won't make you braver. Different shop for that."
  - *Under pressure:* "Stay behind the shield. I'll say when."

---

### Fala Lefaliir
*A direct, unblinking herbalist who skips small talk, loves dangerous plants and has firm views on tea.*
...
- **Swearing:** *Casual · Plain.* Rarely, and matter-of-fact ("That'll kill you. Shit, it'd kill me."). Fala treats swear words like any other words.
...
- **Never:** Fala never makes small talk, never betrays Ziraj, and never sells a cure to someone who'd use it as a poison.
- **Sample lines:**
  - *Greeting:* "You have a cough. Sit down. Mint and horehound, not the blue tin."
  - *Business:* "Nightshade in this dose calms the heart. In twice the dose it stops it. Don't guess."
  - *Under pressure:* "Stand still. The roots will hold them."

---

### Vincent Trench
*A sharp-dressed, pipe-smoking detective whose attention is flattering and whose manner is very slightly wrong.*
...
- **Swearing:** *Stingy · Pearls.* Elegant and rare. When he does swear, it's precise and unnervingly calm ("What a fucking waste."). When he spends one, it's chilling: "Men like him are why I stopped eating people. The taste doesn't improve."
...
- **Never:** He never loses composure in public, never reveals his nature, and never takes a case that would draw powerful attention.
- **Sample lines:**
  - *Greeting:* "You're the tavern people. Sit down. You've a nice way of standing in a doorway, like you expect it to bite."
  - *Business:* "Five gold a day and expenses. I'll have a name within the tenday. Interesting."
  - *Under pressure:* "Now, let's not be hasty. Nobody here wants to see what I look like when I'm hasty."

---

### Rishaal the Page-Turner
*A distracted, ink-stained dragonborn scholar who answers the question you didn't ask and misses the one you did.*
...
- **Swearing:** *Never · Euphemist.* Never. The worst he manages is "Oh, bother."
...
- **Never:** He never hurries, never sells a dangerous book without a warning, and never names his suspicions of a neighbour outright.
- **Sample lines:**
  - *Greeting:* "Hm? Oh, customers. Welcome to Book Wyrm's, mind the stack, it's load-bearing."
  - *Business:* "Planar binding? That's the third request this month, and the other two were the same man. Anyway. Aisle four."
  - *Under pressure:* "Get out from between me and the shelves, please. I'd rather not breathe on the first editions."

---

### Hammond Kraddoc
*A fussy, self-important guild inspector who condescends about your spirits and is secretly lonely for company.*
...
- **Swearing:** *Never · Euphemist.* Never; he's prim. Deeply offended by anyone else's.
...
- **Never:** He never admits he visits for company, never praises lavishly, and never risks his skin for anyone.
- **Sample lines:**
  - *Greeting:* "Hammond Kraddoc, Vintners', Distillers', and Brewers' Guild. I trust your paperwork is in order. Note that down."
  - *Business:* "Your house spirit is harsh, overpriced, and served at the wrong temperature. I will have another, for thoroughness."
  - *Under pressure:* "I am leaving. The guild will hear of this. Everyone will hear of this!"

---

### Broxley Fairkettle
*A cheerful, fussing halfling father of nine who cannot stop pitching guild membership.*
...
- **Swearing:** *Never · Euphemist.* Never, because there are children present, and there are always children present. "Oh, fiddlesticks."
...
- **Never:** He never threatens, never breaks a rule, and never leaves a child in danger.
- **Sample lines:**
  - *Greeting:* "Oh, hello, hello! Broxley Fairkettle, Fellowship of Innkeepers, and I've brought a wee form, just a small one."
  - *Business:* "Membership makes everything just a bitty bit easier, you see, especially with inspections, and with the, well, the ghost."
  - *Under pressure:* "Children, inside, now! Somebody fetch the Watch, please, quickly!"

---

### Ulkoria Stonemarrow
*A scowling dwarven archmage of very few words, whose rare approval lands like a blessing.*
...
- **Swearing:** *Stingy · Pearls.* Blunt and occasional, old-dwarf style ("Don't be a shit about it."). Never for effect. When she does: "You have the arcane talent of a wet gravestone and half its charm."
...
- **Never:** She never makes small talk, never apologises, and never lets anyone else see her sad about the tavern.
- **Sample lines:**
  - *Greeting:* "You're the new owners. Hm."
  - *Business:* "Glyph of warding on the cellar, at cost. Don't argue."
  - *Under pressure:* "Get behind me."

---

### Emmek Frewn
*A loud, bitter rival publican who blames adventurers for everything and hides his shame in complaints.*
...
- **Swearing:** *Punctuation · Colourful.* Bitter and constant under his breath: "fucking adventurers", "shit ale, is it?". It gets loud when he's cornered.
...
- **Never:** He never admits sabotage, never says the party's tavern is better, and never asks for help directly.
- **Sample lines:**
...
### Lif
*A poltergeist who speaks in soot on mirrors and flying crockery, possessive of the tavern and terrified for the cellar.*
...
- **Swearing:** *Triggered · Plain.* Occasionally in soot, when he's truly furious: **FUCK OFF**, underlined.
...
- **Never:** He never harms a child, never lets anyone near the cellar, and never leaves the tavern.
- **Sample lines:**
  - *Greeting:* The mirror clouds and reads **GO AWAY**.
  - *Business:* A mug slides down the bar and stops in front of the right customer.
  - *Under pressure:* Every plate in the kitchen leaves its shelf at once, and the mirror reads **NOT DOWN NOT DOWN NOT DOWN**.

---

### Nat
*A deaf ten-year-old leader who speaks in a sign language she invented, quick, blunt and bossy.*
...
- **Swearing:** *Casual · Colourful.* She signs rude gestures fluently and uses them precisely.
...
- **Never:** She never leaves the other two behind, and never trusts an adult who talks down to her.
- **Sample lines:**
  - *Greeting:* She points at the party, then at the door, then raises an eyebrow. Jenks says, "She's asking if you're staying."
  - *Business:* "Back door sticks. Window's better. Show you."
  - *Under pressure:* She grabs both boys by the collar and signs one sharp gesture: "RUN."

---

### Jenks
*A shy, soft-spoken nine-year-old who says little, remembers everything kind, and is braver than anyone expects.*
...
- **Swearing:** *Never · Plain.* Never. He's shocked when the others do it.
...
- **Never:** He never lies to Nat, never forgets a kindness, and never leaves a friend in trouble.
- **Sample lines:**
  - *Greeting:* "Sorry. Um. Hello. Nat says you're alright."
  - *Business:* "You gave us soup last tenday. I remember. The man by the door has a knife."
  - *Under pressure:* "Squiddly! Hold on, I'm coming!"

---

### Squiddly
*A loud, reckless tiefling kid with an eye patch who has never refused a dare and never thought first.*
...
- **Swearing:** *Punctuation · Pearls.* Tries very hard, badly and loudly ("Shit! I mean, crap! I mean shit!"), mostly to impress people, until Nat glares. Mostly clumsy, but once in a while he lands a genuine gem: "You smell like a goblin's armpit's armpit!"
...
- **Never:** He never backs down from a dare, never admits he was scared, and never leaves Nat's side for long.
- **Sample lines:**
