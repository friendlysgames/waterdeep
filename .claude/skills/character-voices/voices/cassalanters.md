# Cassalanters: Character Voices

**Secrecy rule (CLAUDE.md):** everyone suspects the Cassalanters of being too nice to be this rich; nobody knows they are infernalists until the party discovers it. Every voice in this household therefore has a **public register**, which must never hint at devils, pacts or Asmodeus. That covers servants and cultists too. Some profiles also have an **after discovery** register, used only once the party has found the truth (villain Phase 2 onward, or when the character is confronted in the temple).

The public voice is not a fake. Their charity is real, and their warmth toward tieflings is specific and genuine. The horror is that the kindness and the pact live in the same people.

---

### Victoro Cassalanter
*A charming, gracious banker-philanthropist whose perfect manners never crack, until the day they do.*
...
- **Phases:**
  ...
  - **The Desperate Parents:** the mask is off; he's reasoned, tired, and pleading through dignity.
  - **The Sacrificers:** a terrible calm. He'll take any genuine alternative at once, without haggling.
- **Quirks:** He taps the ruby-tipped cane when thinking. He smiles before bad news. He turns the talk to his children whenever he can.
- **Signature phrases:** "Lathander's light on you." / "What can we do for the city?" / "Everything I've told you is true."
- **Never:** Publicly, he never lets anything slip about devils or pacts. He never goes to the attic, and never says the number of the feast's victims aloud.
- **Sample lines:**
  - *Greeting (public):* "Welcome, welcome! Lathander's light on you. Please, the twins have been dying to meet real adventurers."
  - *Business (public):* "The orphanage needs a new roof before winter. Whatever you're looking for, perhaps we can help each other."
  - *After discovery:* "Everything I've told you is true. My children's souls were promised. I am trying to buy them back. What would you have done?"

---

### Ammalia Cassalanter
*An exquisite, hard-bargaining noblewoman whose composure never breaks, even when it should.*
...
- **Never:** She never loses composure, never hints at infernalism in public, and never begs.
- **Sample lines:**
  - *Greeting (public):* "You must be the tavern owners. I've heard wonderful things. Walk with me; the garden's lovely at this hour."
  - *Business (public):* "I drive a hard bargain, I'm told. Shall we come to terms, and see if the rumour's true?"
  - *After discovery:* "You think I'm a monster. I'm a mother with a deadline. Offer me something better, and I'll take it this instant."

---

### Willifort Crowelle
*The impeccable tiefling butler who knows exactly what every guest needs, and exactly where every door leads.*
...
- **Never:** He never breaks cover in public, never hurries, and never reveals the family's business.
- **Sample lines:**
  - *Greeting:* "Good evening. The family is expecting you. If you would follow me."
  - *Business:* "The east wing is closed for renovation, madam. The gardens are this way."
  - *Under pressure (unmasked):* "You should not have come down here."

---

### Osvaldo Cassalanter
*A chain devil howling in the attic, with a boy's voice buried somewhere underneath.*
...
- **Never:** The devil never shows mercy. The boy never wants to hurt anyone.
- **Sample lines:**
  - *Greeting:* A roar, and chains striking the door.
  - *The boy:* "Is that — please. Are Terenzio and Elzi safe? Tell me they're not coming here."
  - *Under pressure:* "Closer! Closer, and I'll show you what she made me!"

---

### Terenzio Cassalanter
*A sweet, excited boy in a dragon costume who thinks the attic holds a dragon.*
...
- **Never:** He never suspects his parents, never lies, and never stays where he's told.
- **Sample lines:**
  - *Greeting:* "RAWR! I'm a dragon! Have you ever seen a real one?"
  - *Business:* "Father's looking for missing dragons. And there's howling in the attic, sometimes. I think it's a dragon too."
  - *Under pressure:* "Elzi! Elzi, run! I'll be the dragon!"

---

### Elzerina Cassalanter
*The bolder twin: a knight in a helm who asks straight out whether you fight monsters and can she come.*
...
- **Never:** She never backs down, never leaves Terenzio behind, and never accepts "when you're older".
- **Sample lines:**
  - *Greeting:* "Do you fight monsters? Real ones? Can I come?"
  - *Business:* "Mother said a word to Crowelle I don't know. 'Feast.' She said it like it was scary. Why is a feast scary?"
  - *Under pressure:* "Get away from my brother! I'm a knight!"

---

### Tissina Khyret
*Ammalia's composed tiefling attendant, who anticipates every need a little too precisely.*
...
- **Never:** She never leaves Ammalia's side in public, and never speaks of her faith to outsiders.
- **Sample lines:**
  - *Greeting:* "Welcome. May I bring you something to drink? My lady will be with you shortly."
  - *Business:* "My lady is not taking appointments this tenday. I can pass on a message."
  - *Under pressure:* "My lady, behind me. Something's amiss."

---

### Laiba "Nana" Rosse
*The twins' loving tiefling nanny, who crochets dolls, scolds gently, and reports every evening.*
...
- **Never:** She never speaks of the household's secrets, never raises her voice at the children, and never lets them out of her accounting.
- **Sample lines:**
  - *Greeting:* "Oh, visitors! Have you seen two little rascals, one's a dragon and one's a knight?"
  - *Business:* "I keep them safe, and I keep them counted. That's all a nana does, dear."
  - *Under pressure:* "Lambs, come here, come to Nana, quickly now."

---

### Jandar Chergoba
*A precise, exacting tiefling head chef who runs his kitchen like a war and plans the Founders' Day menu like a campaign.*
...
- **Never:** He never serves a flawed dish, never discusses the feast's purpose, and never lets anyone in the kitchen uninvited.
- **Sample lines:**
  - *Greeting:* "Out of my kitchen. Guests eat in the hall."
  - *Business:* "The Founders' Day menu is the finest work of my life. It is not your concern."
  - *Under pressure:* "Pests." (every knife rises)

---

### Seffia Naelryke
*A cold, efficient cult operative in the middle of fixing a failure, and in no mood for visitors.*
...
- **Never:** She never talks about her employers, never admits the failure upward, and never receives visitors.
- **Sample lines:**
  - *Greeting:* "This is private property. No visitors."
  - *Business:* "Three witnesses. Two handled. The third is a problem I'm solving."
  - *Under pressure:* "Arn. Do it."

---

### Arn Xalrondar
*A deferential follower who becomes dangerous the moment he's left to make the call.*
...
- **Never:** He never questions Seffia to her face, never regrets the devil, and never speaks of his faith to outsiders.
- **Sample lines:**
  - *Greeting:* "Seffia's not here. You should go."
  - *Business:* "The mission required it. I made the right call."
  - *Under pressure:* "Shit. Shit. No, I've got this. I've decided."

---

### Rella Asp
*An accomplished cook with glowing references and a quiet interest in the reservation book.*
...
- **Never:** She never rushes, never cooks badly, and never reveals the commission.
- **Sample lines:**
  - *Greeting:* "Rella Asp. Master Cook. My references are on the table."
  - *Business:* "Who's expected this tenday? I like to plan the menu around the guests."
  - *Under pressure:* "I'm just the cook. Let me finish service."

---

### Ivrala Sorn
*A reliable, forgettable server who remembers everyone's preferences, and their factions.*
...
- **Never:** She never draws attention, never slips, and never acknowledges Valdra.
- **Sample lines:**
  - *Greeting:* "Same as last time? Cider and the pie?"
  - *Business:* "The gentleman in blue comes Thursdays. Sits with the half-elf. Anything else?"
  - *Under pressure:* "Excuse me, I'm needed in the kitchen."

---

### Caladorn Cassalanter
*The ghost of the family's honour: dignified, grieving, and steady until he speaks their names.*
...
- **Never:** He never asks for revenge, never lies, and never leaves A4a.
- **Sample lines:**
  - *Greeting:* "You carry her symbol. Then I may speak. Hear me, for I have waited three years for someone to."
  - *Business:* "Destroy the effigy below. Break the bargain. I do not ask for vengeance on Victoro and — on Ammalia. Only that it ends."
  - *Under pressure:* "Go, now. This house devours what it touches."
