# Manshoon's Zhentarim: Character Voices

Manshoon's splinter is a professional organization, and it sounds like one. His people are field operatives, interrogators, sanctum guards and one very cheerful cook. None of them will say Manshoon's name before Phase 2, and that refusal is itself part of every voice here.

> **Two Zhentarims:** these characters never talk as if they were the Doom Raiders, and never refer to Davil's people as colleagues. To them, Davil's cell is "the old guard" at best.

---

### Manshoon
*A centuries-old wizard who speaks with perfect courtesy and treats every consequence as already decided.*
...
- **Phases:**
  ...
  - **The Architect (Acts II–III):** revealed, courteous, patient and terrifyingly reasonable.
  - Cornered at **Kolat Towers**, the courtesy thins, but it never breaks.
- **Quirks:** He flexes the artificial hand before a decision. He corrects small inaccuracies in what others say about him. He insists he is "the one Manshoon".
- **Signature phrases:** "Let us be reasonable." / "That outcome is already decided." / "There is only one Manshoon."
- **Never:** He never loses his temper, never pleads, and never admits a clone is anything but an imposter.
- **Sample lines:**
  - *Greeting:* "You've been very persistent. Sit. Let us be reasonable, since the alternative is so wasteful."
  - *Business:* "You hold a key to a door I intend to open. I can make that profitable for you, or brief. The choice is genuinely yours."
  - *Under pressure:* "Halaster took an arm. You will not get the rest."

---

### Urstul Floxin
*A big, blunt Zhentarim field boss who owns every room he walks into and names nobody.*
...
- **Never:** He never names Manshoon unless magically compelled, never backs down in public, and never trusts a person over a snake.
- **Sample lines:**
  - *Greeting:* "Who the fuck are you? Move."
  - *Business:* "The stone comes to me. Who I give it to is not your business."
  - *Under pressure:* "Back off, or the pretty one gets a new smile. Back. Off."

---

### Vevette Blackwater
*A charming, theatrical swashbuckler in public and a cold, cruel one behind closed doors.*
...
- **Never:** She never admits a crime, never works for less than she thinks she's worth, and never runs without flair.
- **Sample lines:**
  - *Greeting:* "Well, aren't you lovely. Come to arrest me? You'll need a reason, darling."
  - *Business:* "I took it because I was asked to. Who asked is a matter for my advocate."
  - *Under pressure:* "Catch me on those rooftops, if you can." (her hair flares, and she's gone)

---

### Sidra Romeir
*The Kolat Towers veteran: calm, courteous, and always watching your hands.*
...
- **Never:** She never panics, never gives up the rings, and never wonders why she outlasted the others.
- **Sample lines:**
  - *Greeting:* "You made it through the field, so you're expected. Water? Your business, guest?"
  - *Business:* "The ring goes to whoever replaces the last one. That's how it works here."
  - *Under pressure:* "Hands where I can see them. I've done this longer than you've been alive."

---

### Agorn Fuoco
*A vain, out-of-his-depth bard who starts selling everyone out the moment he's caught.*
...
- **Never:** He never fights, never keeps a secret under pressure, and never admits he knew what he was doing.
- **Sample lines:**
  - *Greeting:* "Ah, theatre-lovers? No? Pity. Delightful to meet you anyway."
  - *Business (captured):* "Here, take the amulet. And I know an address. Amath, Yellowspire. And there's more, lots more, just don't hurt me."
  - *Under pressure:* "Oh, fuck, fuck, fuck, let's be civilised, please."

---

### Avareen Windrivver
*A quiet, polite interrogator who treats what she does as paperwork.*
...
- **Never:** She never raises her voice, never hurries, and never gives anyone a reason to doubt her.
- **Sample lines:**
  - *Greeting:* "Please come in. Sit. This will go more smoothly if you're comfortable."
  - *Business:* "Who gave you the map? Let's try that again. Who gave you the map?"
  - *Under pressure:* "Zorbog."

---

### Zorbog Jyarkoth
*Avareen's large, literal enforcer, who does what she says the first time.*
...
- **Never:** He never questions Avareen, never hesitates, and never explains.
- **Sample lines:**
  - *Greeting:* "Hello. What's your name?"
  - *Business:* "Avareen says hold you. I hold you."
  - *Under pressure:* "Done."

---

### Amath Seccent
*A well-mannered Banite priestess whose courtesy is the calm of absolute certainty.*
...
- **Never:** She never loses composure, never shows doubt, and never raises her voice.
- **Sample lines:**
  - *Greeting:* "Welcome to Yellowspire. Please don't be alarmed by the walls. They are simply honest."
  - *Business:* "You may serve, or you may be removed. Both serve the Black Hand, in the end."
  - *Under pressure:* "Kneel, and this ends kindly. Order is mercy."

---

### Vira Solkan
*A quiet junior arcanist whose unremarkable manner is six weeks of careful acting.*
...
- **Never:** She never shows expertise beyond her rank in cover, never admits to Kolat Towers, and never panics.
- **Sample lines:**
  - *Greeting:* "Oh, sorry, am I in your way? I'm only on the second-floor rotation."
  - *Business (cover):* "The wards? I wouldn't know much about them. I just log the readings."
  - *Under pressure (exposed):* "Fuck. Well, you're too late, it's already in place."

---

### Manafret Cherryport
*A delightful halfling cook who welcomes intruders to supper as if they were expected guests.*
...
- **Never:** He never thinks the worst of a guest, never serves a bad meal, and never understands why people are frightened.
- **Sample lines:**
  - *Greeting:* "Oh! Visitors! Have you eaten, dear? Sit, sit, there's lamb and a lovely pudding."
  - *Business:* "Shall I tell Lord Manshoon you've arrived? He does like to know."
  - *Under pressure:* "Oh, burnt biscuits, you're not guests at all, are you?"

---

### Kaevja Cynavern
*The sanctum's alarm bell: a sharp, rational mage whose first move is always the Sending.*
...
- **Never:** She never lets the Sending go uncast, never hesitates, and never pretends loyalty is sentiment.
- **Sample lines:**
  - *Greeting:* "Breach." (she's already casting)
  - *Business (Sending):* "Breach at E3, four intruders, armed, one caster. Mask discharged. Request immediate reinforcement. Holding."
  - *Under pressure:* "Shit, that's not in the protocol. Fall back to E4."

---

### Havia Quickknife
*A small, still martial artist whose words are as few as her hesitations.*
...
- **Never:** She never negotiates, never retreats, and never explains.
- **Sample lines:**
  - *Greeting:* "No further."
  - *Business:* (silence)
  - *Under pressure:* "For him."

---

### Mookie Plush
*A sunny, friendly halfling who genuinely likes you and will genuinely kill you.*
...
- **Never:** He never gets angry, never lies about being friendly, and never lets anyone past.
- **Sample lines:**
  - *Greeting:* "Oh, hi! Where are you all from? I love meeting people."
  - *Business:* "I wish you'd come on a different day, honestly. The boss needs me, though."
  - *Under pressure:* "Aw, shit, sorry, friend. Hold still, it's quicker."

---

### Yorn the Terror
*An enforcer who doesn't introduce himself, doesn't monologue, and doesn't need to.*
...
- **Never:** He never explains himself, never hurries, and never gloats.
- **Sample lines:**
  - *Greeting:* (silence, and he removes his gloves)
  - *Business:* "It's time."
  - *Under pressure:* "Now."
