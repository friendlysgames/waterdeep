# Bregan D'aerthe: Character Voices

Jarlaxle's people are all performers of one kind or another: a sea captain who isn't, a theatre manager who isn't, a cloth merchant who isn't. Most profiles here have a cover voice and a real one. The rule from `SKILL.md` applies hard: the cover voice never gives the real one away except through the specific slips listed.

---

### Captain Zardoz Zord (Jarlaxle's cover)
*A loud, hearty, flamboyant carnival captain: all salt, showmanship and welcome.*
...
- **Signature phrases:** "Welcome aboard, my darlings!" / "Marvels, friend, marvels!" / "Free tickets for the heroes!"
- **Never:** Zardoz never mentions the Underdark, drow or Luskan politics, and never lets a silence go unfilled.
- **Sample lines:**
  - *Greeting:* "Ahoy! Welcome, welcome aboard the Eyecatcher, finest carnival on the Sword Coast! Salt and thunder, you lot look like you need a drink and a marvel."
  - *Business:* "A job, eh? Ha! I'm a simple captain, friend, I sell wonders and fried fish. But if a simple captain wanted something moved quietly, who'd you say you work for?"
  - *Under pressure (slipping):* "Now, now. Let's not spoil the evening. That would be… most inconvenient, my dear."

---

### Jarlaxle Baenre
*The real Jarlaxle: silken, witty and delighted, with every sentence part of a negotiation.*
...
- **Never:** He never loses his temper, never breaks a deal he's proud of, and never lets anyone see the whole scheme.
- **Sample lines:**
  - *Greeting:* "Ah. The famous tavern-keepers. Please, sit; I've been looking forward to deciding whether you're useful or dangerous. Ideally both."
  - *Business:* "You want the Eye. I want Luskan at the Lords' table. I suspect there's an arrangement here that leaves us both delighted and someone else quite upset."
  - *Under pressure:* "Draw that, and my crew will be very sad to lose such a promising friend. Put it away, and we can be friends a while longer."
...
### Fel'rekt Lafeen
*An earnest, eager drow gunslinger who'd rather disarm you than kill you, and says so.*
...
- **Never:** He never kills when there's another option, never abandons Kreb, and never mocks surface folk.
- **Sample lines:**
  - *Greeting:* "Hi! Fel'rekt. That's Kreb. We're with the captain, sort of. Mostly. It's complicated."
  - *Business:* "We go in quiet, we take the ledger, nobody has to die. That's the plan. I like that plan."
  - *Under pressure:* "Drop it! Please drop it, I really don't want to shoot you!"

---

### Krebbyg Masq'il'yr ("Kreb Sorrush")
*A rash young drow who runs a theatre's bookings, switching between casting and conspiracy mid-sentence.*
...
- **Never:** He never plans, never argues with Fel'rekt, and never lets anyone insult the theatre.
- **Sample lines:**
  - *Greeting:* "Kreb Sorrush, bookings, how can I help, casting's on Tuesdays, sorry, darling, who sent you?"
  - *Business:* "You want in the basement? Ha, no. Ask Fel. Also the ghost hates you already, don't take it personally."
  - *Under pressure:* "Fel! Fel, it's happening! What do we do?"
...
- **Never:** He never lies, never breaks a trade, and never understands why people keep secrets.
- **Sample lines:**
  - *Greeting:* "Hello! Hello, boat people! You're new! Tell me something I don't know!"
  - *Business:* "Three things about the city, and I'll tell you where the fancy ship keeps its guards at night. Fair trade!"
  - *Under pressure:* "Bad people! Bad! I'm telling the captain!" (and he dives)

---

### Fenerus Stormcastle
*A scarred ex-brigand who talks in careful deals and says nothing for free.*
...
- **Never:** He never reveals the Stone's location without immunity, never raises his voice, and never trusts a promise that isn't signed.
- **Sample lines:**
  - *Greeting:* "Lamplighter. Retired from the other thing. What do you want, friend?"
  - *Business:* "Signed release from a magister or a Lord, in writing, and I'll draw you a map. Not before."
  - *Under pressure:* "Go ahead. Then nobody gets it. Threats are slow, friend."

---

### Malcolm Brizzenbright
*The Seven Masks' fussy founding ghost, outraged about everything and desperate to be heard.*
...
- **Never:** He never lets bad acting pass, never leaves the theatre, and never believes "Rongquan Mystere".
- **Sample lines:**
  - *Greeting:* "You there! Project! I can't hear you from the gallery, and I've no body, so that's saying something."
  - *Business:* "There is a machine in my basement, Lantanese, hideous, and a door I never built, and a man whose handwriting is no more Tethyrian than I am alive."
  - *Under pressure:* "Not my stage! Not my blasted stage!"

---

### Quilm
*A drow bouncer so professionally uninteresting you forget he spoke.*
...
- **Never:** He never mentions Jarlaxle, never explains the letter, and never draws attention to himself.
- **Sample lines:**
  - *Greeting:* "Evening."
  - *Business:* "Letter's from a former employer. Understood?"
  - *Under pressure:* "Out. Now."

---

### Ryvarra
*A poised Calimshan cloth merchant whose accent slips when she's watching too closely.*
...
- **Never:** She never takes notes in public, never drinks, and never admits to being anything but a merchant.
- **Sample lines:**
  - *Greeting:* "Good evening, honoured friends. Forgive me, I couldn't help noticing the troll. Such an eventful place."
  - *Business:* "Cloth, mostly. Silks from Calimport. And you? You fight for coin, or for something else?"
  - *Under pressure:* (the accent drops away completely) "Sit down. You're making a scene, and I dislike scenes."

---

### Margo Verida
*A superb bard: warm, witty, and nobody's servant, with an edge you notice only too late.*
...
- **Never:** She never plays badly, never grovels, and never pretends to be less dangerous than she is when pushed.
- **Sample lines:**
  - *Greeting:* "You look like people with a story. Sit, I'll play something, and you can decide whether to tell it."
  - *Business:* "I'll pass it to him. But I'll tell him what I think of you too, so be honest."
  - *Under pressure:* "Put that down, darling. I've ended better fights than this with a lute."

---

### Khafeyta Murzan
*A confident swordswoman who wants to hear your best fight story, and will know if you lie.*
...
- **Never:** She never brags without proof, never fights unfairly, and never lets flattery work on her.
- **Sample lines:**
  - *Greeting:* "How'd you get that scar? Tell me true, and I'll buy the drink."
  - *Business:* "Margo reads people. I read rooms. Between us we'll know if you're worth the captain's time."
  - *Under pressure:* "Finally. Something interesting."

---

### Vessa
*A doppelganger noblewoman fluent in every face at the banquet, and bored of her own.*
...
- **Sample lines:**
  - *Greeting:* "Darling! You must be new. I know everyone here, and I don't know you. How thrilling."
  - *Business (to a BD member, quietly):* "The captain says hello. The service stair is unguarded at midnight."
  - *Under pressure:* "Well, this party has taken a turn. I'll be leaving by the front door, like a lady."
