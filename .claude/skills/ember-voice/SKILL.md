...
| ★ "Quietly" as a non-committal crutch | "he quietly extracted their agents" / "patrols have been quietly reduced" / "the argument he has quietly been making for years" | Say what actually happened: "he pulled their agents out of Waterdeep before anyone noticed". **Literal quiet is fine and encouraged:** moving quietly, speaking quietly, a door closing quietly, "A few old wheel barrows rot quietly". The tell is only the vague hedge on actions that make no sound. The checker skips a "quietly" next to a sound or movement word. |
